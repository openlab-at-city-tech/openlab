...
Plugin URI: https://github.com/boonebgorges/cac-featured-content
Version: 0.9.0
...
add_action( 'admin_init', 'cac_featured_ajax_handler' );
...
function cac_featured_ajax_handler() {
...
class CAC_Featured_Content_Widget extends WP_Widget {
	 ...
	 * will be displayed to administrators. These options can then be found in the $params 
    ...
    'name' => 'CAC Featured Content',
		...
		'description' => 'A widget that allows you to feature content from across the Commons, including Blogs, Groups, Wiki Articles, and People.',
    ...
    // method on the admin widgets page
      ...
      // featured blog
      array(
        'name' => 'Enter featured blog address',
        'desc' => 'no http:// required',
        'id'   => 'featured_blog',
        'type' => 'text',
      ...
      // featured post
      array(
        'name' => 'Enter featured post name',
        'desc' => 'You must enter a blog address first <br /> no http:// required',
        'id'   => 'featured_post',
        'type' => 'text',
      ...
      // featured group
      array(
        'name'  => 'Enter featured group name',
        'desc'  => '',
        'id'    => 'featured_group',
        'type'  => 'text',
      ...
      // featured member
      array(
        'name' => 'Enter featured member username',
        'desc' => '',
        'id'   => 'featured_member',
        'type' => 'text',
      ...
      array(
        'name' => 'Enter featured resource title',
        'desc' => '',
      ...
      array(
        'name' => 'Enter featured resource link',
        'desc' => '',
      ...
      array(
        ...
        'desc'    => 'Leave this blank and we\'ll select text appropriate for your featured item (e.g. a group description).',
        'id'      => 'custom_description',
        'type'    => 'textarea'
      ),
      // text crop length
      array(
        'name'    => 'Crop Length (characters)',
        'desc'    => '',
        'id'      => 'crop_length',
        'type'    => 'text',
        'class'   => 'small-text',
      ...
      array(
        'name'    => 'Image URL',
        'desc'    => 'Leave this blank and we\'ll try to find an image appropriate to your featured item (e.g. an avatar).',
        'id'      => 'image_url',
        'type'    => 'text',
      ),
      // image width
