	...
	********************************************************************/
	...
	function widget($args, $instance) {
		...
		******************************************************/
		...
		//mod to crop_config to match current designs - jwu
		$this->crop_config = $this->crop_length;
		//end mod
	...
	function form($instance) {
		...
		***********************/
		...
		$image_crop_rule = strip_tags($instance['image_crop_rule']);
	...
	**/
		    ...
		    <h4><a href="<?php echo $site_url ?>"><?php echo $blog_name?></a></h4>
			 <p>
					<?php if($this->crop_length): ?>
						<?php $output = $this->cacfc->cropHTML($description, $this->crop_config);?>
					<?php else: ?>
	...
	public function renderType_GROUP() {
		...
		<?php if(bp_has_groups('type=single-group&slug='.$this->group_slug)): ?>
            ...
            <?php //mod to CAC Featured Content to match current designs - "extra" info taken out
				//div container added for content to make a nice float
				//changed avatar dimensions - to-do: use image dimensions presented in widget ?>
				<?php bp_group_avatar(array('width' => '114', 'height'=>'114')) ?>
