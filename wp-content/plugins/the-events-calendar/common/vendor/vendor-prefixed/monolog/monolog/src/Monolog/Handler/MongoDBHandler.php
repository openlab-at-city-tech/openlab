...
use TEC\Common\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \TEC\Common\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \TEC\Common\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
