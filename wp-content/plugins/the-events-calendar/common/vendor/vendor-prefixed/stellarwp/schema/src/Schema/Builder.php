...
class Builder
{
     ...
     * StellarWP\DB class.
     *
     * @var class-string<\TEC\Common\StellarWP\DB\DB>
     */
    protected $db;
    /**
     * Constructor.
     *
     * @param class-string<\TEC\Common\StellarWP\DB\DB>|null $db StellarWP\DB class.
    ...
    {
        return $this->container->get(\TEC\Common\StellarWP\Schema\Tables\Collection::class);
    }
    /**
    ...
    {
        return $this->container->get(\TEC\Common\StellarWP\Schema\Tables\Collection::class)->get_tables_needing_updates();
    }
    /**
