			...
			<td colspan="<?php echo esc_attr( $GLOBALS['wp_list_table']->get_column_count() ); ?>" class="plugin-update colspanchange">
				<div class="update-message notice inline notice-error notice-alt">
					...
					if ( tb_tp_fs()->is_plan_or_trial__premium_only( 'pro' ) ) {
						echo '<p>';
						echo '<strong>' . __( 'This retired TablePress Extension will stop working with TablePress 3 later this year!', 'tablepress' ) . '</strong><br>';
						printf( __( 'To continue using its features, please deactivate the Extension and activate its corresponding feature module of your TablePress Premium license on the <a href="%2$s">“Modules” screen</a>.', 'tablepress' ), esc_url( admin_url( 'plugins.php' ) ), esc_url( TablePress::url( array( 'action' => 'modules' ) ) ) );
						echo '</p>';
					}
