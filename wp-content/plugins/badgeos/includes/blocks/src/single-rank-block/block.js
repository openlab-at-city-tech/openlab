...
registerBlockType(
	'bos/badgeos-single-rank-block',
	{
		...
		title: __( 'Single Rank - block' ), // Block title.
												...
												default: ""
													...
													image_height: {
														...
														default: ""
															 ...
															 */
															edit: (props) => {
																	const { attributes: { rank, image_width, image_height, show_description, show_thumb, show_title }, setAttributes } = props;
																	let ranks = [];
																	wp.apiFetch( { path: 'badgeos/ranks' } ).then(
																		posts => posts.map(
                                                                        function (post) {
                                                                                    ranks.push( post )
                                                                        }
		...
		return [
			el(
				...
				el(
					ServerSideRender,
					{
						block: 'bos/badgeos-single-rank-block',
						attributes: props.attributes
							}
				)
            ),
			< InspectorControls >
				< PanelBody title         = {__( 'Rank ID', 'badgeos' )} className = "bos-block-inspector" >
					< PanelRow >
						< label htmlFor   = "bos-block-roles" className = "bos-block-inspector__label" >
							{__( 'Render a single rank.', 'badgeos' )}
						< / label >
					< / PanelRow >
					< PanelRow >
						< Select
