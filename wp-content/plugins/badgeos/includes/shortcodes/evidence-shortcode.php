        ...
        ?>
            <div class="evidence_main">
                ...
                <div class="right_col">
                    ...
                    <?php $content_before = ''; ?>
                    <?php $content_after  = ''; ?>
                    <?php echo apply_filters( 'badgeos_evidence_before_post_content', $content_before, $achievement );?>
                    <?php if( $achievement ) {  ?>
                    ...
                    <?php } ?>
                    <?php echo apply_filters( 'badgeos_evidence_after_post_content', $content_after, $achievement );?>
