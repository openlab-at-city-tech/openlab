    ...
    <form method="post" action="<?php echo isset($_SERVER['REQUEST_URI']) ? esc_url(sanitize_text_field(wp_unslash($_SERVER['REQUEST_URI']))) : ""; ?>">
        ...
        ?>
                <div class="updated notice  is-dismissible">
                    <p><strong><?php esc_html_e('Changes Saved.', 'breadcrumb'); ?></strong></p>
                </div>
        ...
        <div class="settings-tabs-loading" style=""><?php esc_html_e('Loading...', 'breadcrumb'); ?></div>
        <div class="settings-tabs vertical has-right-panel" style="display: none">
            ...
            <p class="submit">
                ...
                <input class="button button-primary" type="submit" name="Submit" value="<?php esc_html_e('Save Changes', 'breadcrumb') ?>" />
            </p>
