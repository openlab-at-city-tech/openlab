...
<div class="schedule_placeholder">
	<?php if (metaslider_pro_is_installed()) : ?>
		...
		<p><?php printf(_x('Have an expired license? Use coupon code %s for a %s discount', 'A coupon code and a discount amount', 'ml-slider'), '<strong>unlockscheduling</strong>', '50%'); ?></p>
