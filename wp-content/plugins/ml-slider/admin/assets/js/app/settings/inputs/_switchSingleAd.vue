	...
	<div class="mt-2 sm:flex sm:items-start sm:justify-between">
		...
		<div class="mt-5 sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:flex sm:items-center">
			<span
				...
				class="opacity-50 pointer-events-none relative inline-block flex-no-shrink h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-50 focus:outline-none focus:shadow-outline"
				role="checkbox"
				tabindex="0">
				<span
					aria-hidden="true"
			...
			</span> <a :original-title="proText" href="https://www.metaslider.com/upgrade?utm_source=lite&amp;utm_medium=banner&amp;utm_campaign=pro" target="_blank" class="dashicons dashicons-lock is-pro-setting tipsy-tooltip-top"></a>
		</div>
	</div>
