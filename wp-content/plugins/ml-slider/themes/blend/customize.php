    ...
    array(
        ...
        'fields' => array(
            array(
                ...
                'css' => '%s .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a:not(.flex-active) { border-color: %s }'
            ),
            array(
                'label' => esc_html__('Hover', 'ml-slider'),
                ...
                'type' => 'color',
                'default' => '#ffffff',
                'css' =>  '%s .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a:hover { border-color: %s }'
            ),
            array(
    ...
    array(
        ...
        'fields' => array(
            array(
                ...
                'css' =>  '%s .flexslider .caption-wrap { background: linear-gradient(rgba(0,0,0,0),%s) }'
            ),
            array(
