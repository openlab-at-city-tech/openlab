    ...
    array(
        ...
        'fields' => array(
            array(
                ...
                'type' => 'color',
                'default' => '#dd6923',
                'css' => '%s .flexslider .flex-control-nav li a:not(.flex-active) { background-color: %s }'
            ),
            array(
                'label' => esc_html__('Hover', 'ml-slider'),
                ...
                'type' => 'color',
                'default' => '#dd6923',
                'css' => '%s .flexslider .flex-control-nav li a:hover { background-color: %s }'
            ),
            array(
    ...
    array(
        ...
        'fields' => array(
            array(
                ...
                'type' => 'color',
                'default' => '#016fb9',
                'css' =>  '%s .flexslider .caption-wrap { background: linear-gradient(to bottom, rgba(0,0,0,0), %s) }'
            ),
            array(
