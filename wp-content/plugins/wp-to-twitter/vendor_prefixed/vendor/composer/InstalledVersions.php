 ...
 */
namespace WpToTwitter_Vendor\Composer;

use WpToTwitter_Vendor\Composer\Autoload\ClassLoader;
use WpToTwitter_Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('WpToTwitter_Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
