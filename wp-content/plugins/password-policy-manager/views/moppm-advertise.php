...
?>
	<div class="moppm-2fa-ad">
		...
		<div class="moppm-2fa-info">
			...
			<h1 class="moppm_h1_ad"><a href="https://wordpress.org/plugins/miniorange-2-factor-authentication/" target="_blank"><?php esc_html_e( 'Google Authenticator (2FA , MFA, OTP SMS and Email) | Passwordless login', 'password-policy-manager' ); ?></a></h1>
