...
<?php if ($updateMail == false || empty($updateMail)) { ?>
    <div class="form-inline">
        ...
        <label class="b2s-mail-update-success b2s-text-xl b2s-color-white" style="display: none;"><i class="glyphicon glyphicon-ok glyphicon-success"></i>  <?php esc_html_e("subscribed", "blog2social") ?> </label>
    </div>
