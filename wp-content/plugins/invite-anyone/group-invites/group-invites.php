...
//#wds - changed display of name on member list to use Name and Last Name as that is how full name is stored on this site
//		$display_name = xprofile_get_field_data("Name",$user_id) . " " . xprofile_get_field_data("Last Name",$user_id);
