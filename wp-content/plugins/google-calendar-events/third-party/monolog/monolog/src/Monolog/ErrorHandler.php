...
class ErrorHandler
{
    ...
    private function handleException(\Throwable $e)
    {
        ...
        $this->logger->log($level, \sprintf('Uncaught Exception %s: "%s" at %s line %s', \SimpleCalendar\plugin_deps\Monolog\Utils::getClass($e), $e->getMessage(), $e->getFile(), $e->getLine()), ['exception' => $e]);
    ...
    public function handleFatalError()
    {
        ...
        if ($lastError && \in_array($lastError['type'], self::$fatalErrors, \true)) {
            ...
            if ($this->logger instanceof \SimpleCalendar\plugin_deps\Monolog\Logger) {
