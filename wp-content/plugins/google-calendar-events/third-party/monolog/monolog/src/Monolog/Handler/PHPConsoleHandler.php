...
use SimpleCalendar\plugin_deps\PhpConsole\Connector;
use SimpleCalendar\plugin_deps\PhpConsole\Handler as VendorPhpConsoleHandler;
use SimpleCalendar\plugin_deps\PhpConsole\Helper;
use SimpleCalendar\plugin_deps\Monolog\LogRecord;
use SimpleCalendar\plugin_deps\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('SimpleCalendar\plugin_deps\PhpConsole\Connector')) {
