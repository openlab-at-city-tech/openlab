...
use SimpleCalendar\plugin_deps\Monolog\Handler\SyslogUdp\UdpSocket;
/**
 ...
 */
class SyslogUdpHandler extends \SimpleCalendar\plugin_deps\Monolog\Handler\AbstractSyslogHandler
{
    const RFC3164 = 0;
    const RFC5424 = 1;
    const RFC5424e = 2;
