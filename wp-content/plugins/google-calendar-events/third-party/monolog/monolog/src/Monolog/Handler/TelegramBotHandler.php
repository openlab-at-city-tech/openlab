 ...
 */
class TelegramBotHandler extends \SimpleCalendar\plugin_deps\Monolog\Handler\AbstractProcessingHandler
{
    ...
    protected function send(string $message) : void
    {
        ...
        $result = \SimpleCalendar\plugin_deps\Monolog\Handler\Curl\Util::execute($ch);
