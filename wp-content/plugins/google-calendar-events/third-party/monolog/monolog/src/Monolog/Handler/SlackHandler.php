...
use SimpleCalendar\plugin_deps\Monolog\Handler\Slack\SlackRecord;
/**
 ...
 */
class SlackHandler extends \SimpleCalendar\plugin_deps\Monolog\Handler\SocketHandler
{
    /**
     * Slack API token
     * @var string
    ...
    public function __construct(string $token, string $channel, ?string $username = null, bool $useAttachment = \true, ?string $iconEmoji = null, $level = Logger::CRITICAL, bool $bubble = \true, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array())
    {
        if (!\extension_loaded('openssl')) {
            throw new \SimpleCalendar\plugin_deps\Monolog\Handler\MissingExtensionException('The OpenSSL PHP extension is required to use the SlackHandler');
        }
