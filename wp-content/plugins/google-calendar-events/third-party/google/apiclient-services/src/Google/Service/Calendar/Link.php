...
class Google_Service_Calendar_Link extends Google_Model
{
    ...
    protected $displayInfoType = 'SimpleCalendar\plugin_deps\Google_Service_Calendar_DisplayInfo';
    protected $displayInfoDataType = '';
    protected $launchInfoType = 'SimpleCalendar\plugin_deps\Google_Service_Calendar_LaunchInfo';
