...
class ApprovalList extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(ApprovalList::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_ApprovalList');
