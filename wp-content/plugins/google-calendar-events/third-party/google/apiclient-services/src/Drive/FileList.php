...
class FileList extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(FileList::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_FileList');
