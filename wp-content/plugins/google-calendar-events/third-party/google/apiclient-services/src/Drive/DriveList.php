...
class DriveList extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(DriveList::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_DriveList');
