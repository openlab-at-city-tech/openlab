...
class ModifyLabelsRequest extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(ModifyLabelsRequest::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_ModifyLabelsRequest');
