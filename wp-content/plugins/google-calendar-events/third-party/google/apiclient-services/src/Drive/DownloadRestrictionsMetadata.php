...
class DownloadRestrictionsMetadata extends \SimpleCalendar\plugin_deps\Google\Model
{
...
class_alias(DownloadRestrictionsMetadata::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_DownloadRestrictionsMetadata');
