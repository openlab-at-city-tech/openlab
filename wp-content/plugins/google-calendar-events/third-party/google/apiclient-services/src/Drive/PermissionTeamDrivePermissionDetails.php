...
class PermissionTeamDrivePermissionDetails extends \SimpleCalendar\plugin_deps\Google\Model
{
    /**
     * @var bool
     */
...
class_alias(PermissionTeamDrivePermissionDetails::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_PermissionTeamDrivePermissionDetails');
