...
class CalendarListEntry extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(CalendarListEntry::class, 'SimpleCalendar\plugin_deps\Google_Service_Calendar_CalendarListEntry');
