...
class Factory
{
    protected $className = \SimpleCalendar\plugin_deps\Carbon\Carbon::class;
    protected $settings = [];
    ...
    public function __call($name, $arguments)
    {
        ...
        return $result instanceof \SimpleCalendar\plugin_deps\Carbon\CarbonInterface && !empty($settings) ? $result->settings($settings) : $result;
    }
}
