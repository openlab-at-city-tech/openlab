...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
     ...
     * @var string
     */
    public const RFC7231_FORMAT = 'SimpleCalendar\\plugin_deps\\D, d M Y H:i:s \\G\\M\\T';
    /**
     ...
     * @return int
     */
    public function diffFiltered(\SimpleCalendar\plugin_deps\Carbon\CarbonInterval $ci, Closure $callback, $date = null, $absolute = \true);
    /**
     ...
     * @return $this
     */
    public function setLocalTranslator(\SimpleCalendar\plugin_deps\Symfony\Component\Translation\TranslatorInterface $translator);
    /**
     ...
     * @return void
     */
    public static function setTranslator(\SimpleCalendar\plugin_deps\Symfony\Component\Translation\TranslatorInterface $translator);
    /**
     ...
     * @return string
     */
    public function translate(string $key, array $parameters = [], $number = null, \SimpleCalendar\plugin_deps\Symfony\Component\Translation\TranslatorInterface $translator = null, bool $altNumbers = \false) : string;
    /**
     ...
     * @return string
     */
    public static function translateWith(\SimpleCalendar\plugin_deps\Symfony\Component\Translation\TranslatorInterface $translator, string $key, array $parameters = [], $number = null) : string;
    /**
