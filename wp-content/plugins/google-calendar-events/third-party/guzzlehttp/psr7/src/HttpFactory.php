...
use SimpleCalendar\plugin_deps\Psr\Http\Message\RequestFactoryInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\RequestInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\ResponseFactoryInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\ResponseInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\ServerRequestFactoryInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\ServerRequestInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\StreamFactoryInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\StreamInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\UploadedFileFactoryInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\UploadedFileInterface;
use SimpleCalendar\plugin_deps\Psr\Http\Message\UriFactoryInterface;
