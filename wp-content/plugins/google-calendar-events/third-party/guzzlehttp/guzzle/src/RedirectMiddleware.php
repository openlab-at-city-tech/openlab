...
class RedirectMiddleware
{
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response) : RequestInterface
    {
        ...
        $modify['uri'] = $uri;
        \SimpleCalendar\plugin_deps\GuzzleHttp\Psr7\Message::rewindBody($request);
        ...
        return \SimpleCalendar\plugin_deps\GuzzleHttp\Psr7\Utils::modifyRequest($request, $modify);
    }
    /**
    ...
    {
        $location = \SimpleCalendar\plugin_deps\GuzzleHttp\Psr7\UriResolver::resolve($request->getUri(), new \SimpleCalendar\plugin_deps\GuzzleHttp\Psr7\Uri($response->getHeaderLine('Location')));
