...
namespace SimpleCalendar\plugin_deps\Psr\Log\Test;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    public function testContextCanContainAnything()
    {
        ...
        \fclose($closed);
        $context = array('bool' => \true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => array('with object' => new \SimpleCalendar\plugin_deps\Psr\Log\Test\DummyTest()), 'object' => new \DateTime(), 'resource' => \fopen('php://memory', 'r'), 'closed' => $closed);
