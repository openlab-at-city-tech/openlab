...
_ready(function () {
    body = document.body;
});_N2.d('SmartSliderBlock', ['SmartSliderAbstract'], function () {
     ...
     * @constructor
     */
    function SmartSliderBlock(elementID, parameters) {

        this.type = 'block';
        this.responsiveClass = _N2.SmartSliderResponsiveBlock;

        _N2.SmartSliderAbstract.prototype.constructor.call(this, elementID, parameters);
    }

    SmartSliderBlock.prototype = Object.create(_N2.SmartSliderAbstract.prototype);
    SmartSliderBlock.prototype.constructor = SmartSliderBlock;

    SmartSliderBlock.prototype.initResponsiveMode = function () {

        this.responsive = new _N2.SmartSliderResponsiveBlock(this, this.parameters.responsive);
        this.responsive.start();

        _N2.SmartSliderAbstract.prototype.initResponsiveMode.call(this);
    };

    SmartSliderBlock.prototype.initMainAnimation = function () {

        this.mainAnimation = false;

        if (!this.isAdmin && !this.disabled.postBackgroundAnimations && this.parameters.postBackgroundAnimations != false) {
            this.postBackgroundAnimation = new _N2.SmartSliderPostBackgroundAnimation(this, false);
        }
    };

    SmartSliderBlock.prototype.afterRawSlidesReady = function () {
    ...
    SmartSliderBlock.prototype.getSlideBackgroundContainer = function () {
        return this.sliderElement.querySelector('.n2-ss-slide').parentNode;
    };


    return SmartSliderBlock;
});_N2.d('SmartSliderResponsiveBlock', ['SmartSliderResponsive'], function () {
     ...
     */
    function SmartSliderResponsiveBlock() {
    ...
    SmartSliderResponsiveBlock.prototype = Object.create(_N2.SmartSliderResponsive.prototype);
    SmartSliderResponsiveBlock.prototype.constructor = SmartSliderResponsiveBlock;

    SmartSliderResponsiveBlock.prototype.init = function () {
    ...
    SmartSliderResponsiveBlock.prototype.calculateResponsiveValues = function () {
    ...
    return SmartSliderResponsiveBlock;
});_N2.d('ss-block',['SmartSliderBlock','SmartSliderResponsiveBlock']);})(window);