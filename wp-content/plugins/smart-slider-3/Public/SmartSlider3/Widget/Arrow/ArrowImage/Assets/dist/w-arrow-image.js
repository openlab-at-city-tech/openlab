...
_ready(function () {
    body = document.body;
});_N2.d('SmartSliderWidgetArrowImage', 'SmartSliderWidget', function () {
     ...
     * @constructor
     */
    function SmartSliderWidgetArrowImage(slider) {

        this.key = 'arrow';

        this.previous = new Arrow('previous', slider, 'previousWithDirection');
        this.next = new Arrow('next', slider, 'nextWithDirection');
    }
     ...
     */
    function Arrow(key, slider, action) {

        this.___action = action;

        _N2.SmartSliderWidget.prototype.constructor.call(this, slider, key, '#' + slider.elementID + '-arrow-' + key);
    }

    Arrow.prototype = Object.create(_N2.SmartSliderWidget.prototype);
    Arrow.prototype.constructor = Arrow;

    Arrow.prototype.onStart = function () {

        _addEventListener(this.widget, 'click', (function (e) {
            e.stopPropagation();
            this.slider[this.___action]();
        }).bind(this));
    };
