...
$gconnect_theme = new GConnect_Theme( function_exists( 'bp_tpack_init' ) );
/*
 * Login Widget
 */
...
function gconnect_GB_admin_notice() { ?>
		<div id="message" class="updated fade">
			<p><?php printf( __( 'Please <a href="%s">switch</a> to a non-GenesisBuddy child theme to enable the BuddyPress features in Genesis Connect.', 'genesis-connect' ), admin_url( 'themes.php' ) ) ?></p>
		</div>
<?php	}
