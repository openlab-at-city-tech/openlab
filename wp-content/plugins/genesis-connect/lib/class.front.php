...
class GConnect_Front {
	...
	function set_addon( $directory = '', $url = '' ) {
		$this->addon_directory = $directory;
		$this->addon_url = $url;
	}
	...
	function after_setup_theme() {
		if( !is_admin() && !function_exists( 'bp_dtheme_ajax_querystring' ) )
...
<div id="<?php echo $this->get_option( 'subnav' ); ?>">
    <div class="wrap">
        <ul id="bpauto" class="nav">
                <?php do_action( 'gconnect_before_bp_nav' ); ?>
                ...
                <?php if ( bp_is_active( 'groups' ) ) : ?>
                        <li<?php if ( bp_is_page( $bp->active_components['groups'] ) || bp_is_group() ) : ?> class="current_page_item"<?php endif; ?>>
                                <a href="<?php echo $bp->root_domain ?>/<?php echo $bp->active_components['groups']; ?>" title="<?php _e( 'Groups', 'buddypress' ) ?>"><?php _e( 'Groups', 'buddypress' ) ?></a>
                        </li>
                    <?php if ( bp_is_active( 'forums' ) && !(int) get_site_option( 'bp-disable-forum-directory' ) ) : ?>
                            <li<?php if ( bp_is_page( $bp->active_components['forums'] ) ) : ?> class="current_page_item"<?php endif; ?>>
                                    <a href="<?php echo $bp->root_domain ?>/<?php echo $bp->active_components['forums']; ?>" title="<?php _e( 'Forums', 'buddypress' ) ?>"><?php _e( 'Forums', 'buddypress' ) ?></a>
                            </li>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ( is_multisite() && bp_is_active( 'blogs' ) ) : ?>
                        <li<?php if ( bp_is_page( $bp->active_components['blogs'] ) ) : ?> class="current_page_item"<?php endif; ?>>
                                <a href="<?php echo $bp->root_domain ?>/<?php echo $bp->active_components['blogs']; ?>" title="<?php _e( 'Blogs', 'buddypress' ) ?>"><?php _e( 'Blogs', 'buddypress' ) ?></a>
                        </li>
                <?php endif; ?>
                <?php do_action( 'bp_nav_items' ); ?>
        </ul>
        <?php do_action( 'gconnect_nav_items' ); ?>
        <div class="clear"></div>
    </div>
</div>
	<?php	}
