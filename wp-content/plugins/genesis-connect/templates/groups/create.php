...
?>
		<form action="<?php bp_group_creation_form_action() ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
			...
			<div class="item-body" id="group-create-body">
				<?php if ( bp_is_group_creation_step( 'group-details' ) ) : /* Group creation step 1: Basic group details */ ?>
				...
				<?php elseif ( bp_is_group_creation_step( 'group-settings' ) ) : /* Group creation step 2: Group settings */ ?>
				...
				<?php elseif ( bp_is_group_creation_step( 'group-avatar' ) ) : /* Group creation step 3: Avatar Uploads */ ?>
				...
				<?php elseif ( bp_is_group_creation_step( 'group-invites' ) ) : /* Group creation step 4: Invite friends to group */ ?>
