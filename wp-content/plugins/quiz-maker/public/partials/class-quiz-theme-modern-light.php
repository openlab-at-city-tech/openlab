...
class Quiz_Theme_Modern_Light extends Quiz_Maker_Public{
    ...
    protected function define_theme_styles(){
        wp_enqueue_style($this->plugin_name.'modern_light_css',dirname(plugin_dir_url(__FILE__)) . '/css/theme_modern_light.css', array(), false, 'all');
    }
        ...
        $additional_css = "
            <style>
                #ays-quiz-container-".$quiz_id." .ays-field{
                    background:" . $this->hex2rgba($quiz->quizColors['Color'], '0.05') . " ;
                }
