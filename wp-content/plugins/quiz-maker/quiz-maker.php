 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '21.5.7' );
define( 'AYS_QUIZ_VERSION', '21.5.7' );
         ...
         <div class="ays-notice-banner">
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        <li class="modile-ddmenu-xss"><a class="ays-btn" href="https://ays-pro.com/index.php/wordpress/quiz-maker/" target="_blank">PRO</a></li>
                        ...
                        <li class="modile-ddmenu-lg"><a class="ays-btn" href="https://freedemo.ays-pro.com/quiz-maker-demo-free/" target="_blank">Demo</a></li>
