    ...
    <div class="container-fluid">
        ...
        <form class="ays-quiz-attribute-form" id="ays-quiz-attribute-form" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class='ays-text-input' id='ays-attribute-name' name='ays_name' required type='text' value='<?php echo  (isset($quiz_attribute['name']))?stripslashes(htmlentities($quiz_attribute['name'])):''; ?>'>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_attr_options" <?php echo (!isset($quiz_attribute['type']) || $quiz_attribute['type'] != "select") ? 'style="display:none"' : ''; ?>>    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="ays_quiz_attr_options" id="ays_quiz_attr_option" class="ays-text-input" value="<?php echo (isset($quiz_attribute['options'])) ? stripslashes(htmlentities($quiz_attribute['options'])) : ''; ?>" placeholder="Red; Blue; Green">
                        </div>
                    </div>
                </div>
            </div>
