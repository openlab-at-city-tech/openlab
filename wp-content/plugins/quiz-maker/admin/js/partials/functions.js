// (function($){
    ...
    String.prototype.hexToRgbA = function(a) {
        ...
        let result1 = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})jQuery/i.exec(this);
        let result2 = /^#?([a-f\d]{1})([a-f\d]{1})([a-f\d]{1})jQuery/i.exec(this);
        if(result1){
            let ays_rgb = {
    ...
    function openQuizMediaUploader(e, element) {
        ...
        let aysUploader = wp.media({
            ...
            if(element.hasClass('add-quiz-bg-image')){
                ...
                let ays_quiz_theme = jQuery(document).find('input[name="ays_quiz_theme"]:checked').val();
    ...
    function show_hide_rows(page) {
        ...
        let rows = jQuery('table.ays-add-questions-table tbody tr');
    ...
    function createPagination(pagination, pagesCount, pageShow) {
        (function (baseElement, pages, pageShow) {
            ...
            function _initNav() {
                ...
                let pagePos = (jQuery('div.ays-question-pagination').width()/2) - (parseInt(jQuery('ul.ays-question-nav-pages>li:first-child').css('width'))/2);
            ...
            function _navPage(toPage) {
                let sel = jQuery('.ays-question-nav-pages li', baseElement), w = sel.first().outerWidth(),
                    diff = toPage - pageNum;
