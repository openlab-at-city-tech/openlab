...
Tags: wpbadgedisplay, badges, openbadges, awards, widget
...
See the [WPBadgeDisplay wiki](https://github.com/davelester/wpbadgedisplay/wiki) for details on the plugin's roadmap and contact information. If you run into a problem, share your problem on the [issue tracker](https://github.com/davelester/WPBadgeDisplay/issues?state=open).
...
= 0.8 (Latest Release) =
* Initial plugin release, including ability to display badges in a widget.
* Tested with WordPress multi-site.