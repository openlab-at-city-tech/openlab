 ...
 *
 * @param array $variation Variation array from gutenberg_build_variation_for_navigation_link.
 * @return void
 */
function gutenberg_gutenberg_register_block_core_navigation_link_variation( $variation ) {
	...
	// Variation will be registered in gutenberg_register_block_core_navigation_link then.
...
// All post types/taxonomies registered before gutenberg_register_block_core_navigation_link, will be handled by that function.
add_action( 'registered_post_type', 'gutenberg_gutenberg_register_block_core_navigation_link_post_type_variation', 10, 2 );
add_action( 'registered_taxonomy', 'gutenberg_gutenberg_register_block_core_navigation_link_taxonomy_variation', 10, 3 );
 ...
 * @return void
 */
function gutenberg_gutenberg_register_block_core_navigation_link_post_type_variation( $post_type, $post_type_object ) {
	if ( $post_type_object->show_in_nav_menus ) {
		$variation = gutenberg_build_variation_for_navigation_link( $post_type_object, 'post-type' );
		gutenberg_gutenberg_register_block_core_navigation_link_variation( $variation );
	}
}
 ...
 * @return void
 */
function gutenberg_gutenberg_register_block_core_navigation_link_taxonomy_variation( $taxonomy, $object_type, $args ) {
	if ( isset( $args['show_in_nav_menus'] ) && $args['show_in_nav_menus'] ) {
		$variation = gutenberg_build_variation_for_navigation_link( (object) $args, 'post-type' );
		gutenberg_gutenberg_register_block_core_navigation_link_variation( $variation );
	}
}
