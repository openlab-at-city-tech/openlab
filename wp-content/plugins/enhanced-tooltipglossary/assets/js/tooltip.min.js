...
else if(c&&!c.nodeType)if(a)a.exports=I;else for(var O in I)y.call(I,O)&&(c[O]=I[O]);else b.he=I})(this);var CM_Tooltip={},CMTT_Footnote={};
CM_Tooltip.gtooltip=function(b){var c,a,e,d,h,g,k,t,p;var q=a=null;return k={create:function(){p=t=!1;if(1!==q){a=document.getElementById("tt");null===a&&(a=document.createElement("div"));jQuery(a).html("");a.setAttribute("id","tt");a.setAttribute("role","tooltip");a.setAttribute("aria-hidden",!0);a.setAttribute("aria-label","Tooltip wrapper");e=document.createElement("div");e.setAttribute("id","tttop");d=document.createElement("div");d.setAttribute("id","ttcont");d.style.padding=b.padding;d.style.backgroundColor=
b.background;d.style.color=b.foreground;d.style.borderWidth=b.borderWidth;d.style.borderStyle=b.borderStyle;d.style.borderColor=b.borderColor;d.style.borderRadius=b.borderRadius;d.style.fontSize=b.fontSize;h=document.createElement("div");h.setAttribute("id","ttbot");!1!==b.close_button&&(!0===b.close_button_mobile&&CM_Tools.Modernizr.touch||!1===b.close_button_mobile)&&(g=document.createElement("span"),g.setAttribute("id","tt-btn-close"),g.setAttribute("class","dashicons "+b.close_symbol),g.setAttribute("aria-label",
"Close the tooltip"),e.appendChild(g),jQuery(a).on("click touchstart",function(m){var l=jQuery("#tt").is(":visible"),w="A"===m.target.tagName&&1<=jQuery(m.target).parents(".cmtt-audio-player").length;t="tt-btn-close"===jQuery(m.target).attr("id");l&&!w&&t&&k.hide()}));a.appendChild(e);a.appendChild(d);a.appendChild(h);document.body.appendChild(a);a.style.opacity=0;a.style.filter="alpha(opacity=0)";if(!1!==b.clickable){if(jQuery(a).on("mouseover",function(){clearTimeout(CM_Tooltip.hideTimeoutId);t&&
(clearTimeout(CM_Tooltip.showTimeoutId),a.style.display="none");jQuery(this).is(":animated")&&!t&&(jQuery(a).removeClass("force-hide"),jQuery(a).removeClass("flipOutY"),jQuery(a).removeClass("zoomOut"),jQuery(a).removeClass("fadeOut"),a.style.opacity=b.endalpha/100,"no_animation"===b.tooltipDisplayanimation?a.style.display="block":"fade_in"===b.tooltipDisplayanimation?jQuery(a).addClass("fadeIn"):"grow"===b.tooltipDisplayanimation?jQuery(a).addClass("zoomIn"):"horizontal_flip"===b.tooltipDisplayanimation?
jQuery(a).addClass("flipInY"):"center_flip"!==b.tooltipDisplayanimation&&jQuery(this).stop().fadeTo(b.timer,b.endalpha/100).show())}),b.close_on_moveout)jQuery(a).on("mouseleave",function(){clearTimeout(CM_Tooltip.showTimeoutId);jQuery(this).is(":animated")||k.hide()})}else document.onmousemove=this.pos;jQuery(document).keyup(function(m){27===m.keyCode&&k.hide()});if(b.touch_anywhere&&!b.only_on_button)jQuery("body").on("click touchstart",function(m){p=jQuery(m.target).parents("#tt").length;jQuery("#tt").is(":visible")&&
!p&&k.hide()});b.link_whole_tt&&(a.style.cursor="pointer",jQuery("body").on("click touchstart",function(m){p=jQuery(m.target).parents("#tt").length;m=jQuery("#tt").is(":visible");var l="undefined"!==typeof c&&null!==c&&"A"===c.tagName;m&&p&&l&&(CM_Tooltip.redirecting=!0,window.location=c.href)}));q=1}},show:function(m,l){this.create();clearTimeout(CM_Tooltip.hideTimeoutId);CM_Tooltip.currentElement=c=l;CM_Tooltip.showTimeoutId=setTimeout(function(){l&&jQuery(l).hasClass("transparent")?d.style.backgroundColor=
"transparent":d.style.backgroundColor=b.background;l&&jQuery(l).data("bgcolor")?d.style.backgroundColor=jQuery(l).data("bgcolor"):d.style.backgroundColor=b.background;l&&jQuery(l).data("tcolor")?d.style.color=jQuery(l).data("tcolor"):d.style.color=b.foreground;d.innerHTML=m;if(jQuery(d).find(".glossaryItemBody").length){var w=jQuery(d).find(".glossaryItemBody");l&&jQuery(l).data("tsize")?w[0].style.fontSize=jQuery(l).data("tsize"):w[0].style.fontSize="inherit"}CM_Tooltip.parseAudioPlayer();a.style.display=
"block";a.style.width="auto";a.style.maxWidth=b.maxw+"px";a.style.minWidth=b.minw+"px";a.setAttribute("aria-hidden",!1);parseInt(a.offsetHeight,10);if("center_flip"===b.tooltipDisplayanimation||"center_flip"===b.tooltipHideanimation){w=jQuery(document.location);w=(new URL(w[0].href)).searchParams.get("disable_tooltips");var x=jQuery("#tt");x.hasClass("no-in")?x.css({display:"block"}):(1===w&&jQuery("#tt").remove(),x.addClass("in"));x.removeClass("out")}jQuery(a).removeClass("force-hide");jQuery(a).removeClass("flipOutY");
jQuery(a).removeClass("zoomOut");jQuery(a).removeClass("fadeOut");a.style.opacity=b.endalpha/100;"no_animation"===b.tooltipDisplayanimation?(a.style.display="block",jQuery(a).stop().fadeTo(b.timer,b.endalpha/100)):"fade_in"===b.tooltipDisplayanimation?jQuery(a).addClass("fadeIn"):"grow"===b.tooltipDisplayanimation?jQuery(a).addClass("zoomIn"):"horizontal_flip"===b.tooltipDisplayanimation?jQuery(a).addClass("flipInY"):"center_flip"!==b.tooltipDisplayanimation&&jQuery(a).stop().fadeTo(b.timer,b.endalpha/
100)},b.delay)},pos:function(m){if("undefined"!==typeof a&&null!==a&&"undefined"!==typeof c&&null!==c){var l=c.getBoundingClientRect();b.toolip_dom_move&&"undefined"!==typeof m.target&&m.target.after(a);if(jQuery("#tt").is(":visible")){var w,x,C;m=w=x=C="unset";var D=0;jQuery("#wpadminbar").length&&(D=jQuery("#wpadminbar").height());a.style.left=m;a.style.bottom=C;a.style.top=x;a.style.right=w;var J=jQuery(window).width();var F=jQuery(window).height();a.style.overflow="none";a.style.maxHeight=null;
a.style.marginTop=null;var y=l.y-b.top-D,z=F-l.bottom-b.top,E=l.x-b.left,G=J-l.right-b.left,B=0;b.toolip_dom_move||(B=window.scrollY+1);var A=parseInt(a.style.minWidth);"vertical"!==b.placement&&(A<E||A<G)?(E>G?(w=B?J-l.left+b.left+"px":c.offsetWidth+b.left+"px",E<a.offsetWidth&&(a.style.maxWidth=E+"px")):(m=B?l.right+b.left+"px":c.offsetWidth+b.left+"px",G<a.offsetWidth&&(a.style.maxWidth=G+"px")),a.offsetHeight>F?(x=B+b.top+D+"px",a.style.overflow="auto",a.style.maxHeight=F-D-b.top-5+"px"):B?(l=
0,y>z?(z<a.offsetHeight&&(l=a.offsetHeight-z),x=B+y-l+"px"):x=B+y+"px"):y>z?C=-z+"px":x=y+"px"):y>z?(y<a.offsetHeight&&(a.style.overflow="auto",a.style.maxHeight=y+"px"),B?(C=-B+z+c.offsetHeight+b.top+"px",m=Math.max(l.left-a.offsetWidth/2+c.offsetWidth/2,0)+"px"):a.style.marginTop=-a.offsetHeight-b.top-c.offsetHeight+"px"):(z<a.offsetHeight&&(a.style.overflow="auto",a.style.maxHeight=z+"px"),B?(C=-B+z-a.offsetHeight+"px",m=Math.max(l.left-a.offsetWidth/2+c.offsetWidth/2,0)+"px"):a.style.marginTop=
b.top+"px");a.style.left=m;a.style.bottom=C;a.style.top=x;a.style.right=w;b.clickable&&(document.onmousemove=null);CM_Tools.Modernizr.touch&&(document.onmousemove=null)}}},hide:function(){if(q){CM_Tooltip.currentElement=c=null;a.setAttribute("aria-hidden",!0);if("center_flip"===b.tooltipDisplayanimation||"center_flip"===b.tooltipHideanimation){if(jQuery("#tt").hasClass("no-out"))jQuery("#tt").addClass("temp");else{var m=jQuery(document.location);1==(new URL(m[0].href)).searchParams.get("disable_tooltips")&&
jQuery("#tt").remove();jQuery("#tt").addClass("out")}jQuery("#tt").removeClass("in")}jQuery(a).removeClass("flipInY");jQuery(a).removeClass("zoomIn");jQuery(a).removeClass("fadeIn");jQuery(a).removeClass("tooltip-bloated-content");"no_animation"===b.tooltipHideanimation?(jQuery(a).addClass("force-hide"),a.style.display="none !important",jQuery(a).stop().fadeOut(b.timer).fadeTo(0,0).css("top","-9999px").css("left","-9999px").css("display","none")):"fade_out"==b.tooltipHideanimation?jQuery(a).addClass("fadeOut"):
"shrink"==b.tooltipHideanimation?jQuery(a).addClass("zoomOut"):"horizontal_flip"==b.tooltipHideanimation?jQuery(a).addClass("flipOutY"):"center_flip"!=b.tooltipHideanimation&&jQuery(a).stop().fadeOut(b.timer).fadeTo(0,0).css("top","-9999px").css("left","-9999px").css("display","none");jQuery("#tt audio").each(function(){this.pause();this.currentTime=0});CM_Tooltip.hideTimeoutId=setTimeout(function(){jQuery(a).stop().fadeOut(b.timer).fadeTo(0,0).css("top","-9999px").css("left","-9999px").css("display",
"none")},b.timer);jQuery("#tt iframe").remove()}}}};CM_Tooltip.glossaryTip=null;
(function(b){b.fn.glossaryTooltip=function(c){var a={top:3,left:23,maxw:400,minw:200,speed:10,timer:500,delay:500,endalpha:95,borderStyle:"none",borderWidth:"0px",borderColor:"#000",borderRadius:"6px",padding:"2px 12px 3px 7px",clickable:!0,close_button:!1,close_button_mobile:!0,only_on_button:!1,close_on_moveout:!0,touch_anywhere:!1,placement:"horizontal",toolip_dom_move:!1,link_whole_tt:!0};a=b.extend({},a,c);CM_Tooltip.glossaryTip=CM_Tooltip.gtooltip(a);if(this.length){if("A"===this[0].tagName&&
CM_Tools.Modernizr.touch)b(document).on("click","[data-cmtooltip]",function(d){d.preventDefault()});a.mobile=0;var e="undefined"!==typeof he?he:exports;return this.each(function(){var d=b(this).data("cmtooltip");if("undefined"!==typeof window.cmtt_data.cmtooltip_definitions&&"undefined"!==typeof window.cmtt_data.cmtooltip_definitions[d]){var h=jQuery("<div>"+window.cmtt_data.cmtooltip_definitions[d]+"</div>").html();b(this).data("cmtooltip",h)}else h=e.decode(d);if("A"===this.tagName&&CM_Tools.Modernizr.touch){a.mobile=
1;d=b(this).data("mobile-support")||0;let g=void 0!==window.cmtt_data&&"1"===window.cmtt_data.mobile_support;if(1===d||0===d&&g)d=b(this).clone(),d.removeAttr("data-cmtooltip"),h+=b('<div class="mobile-link"/>').append(d)[0].outerHTML;b(this).on("touchstart",function(k){CM_Tooltip.glossaryTip.show(h,this);setTimeout(function(){CM_Tooltip.glossaryTip.pos(k)},a.delay+100)});b(this).on("touchmove",function(k){k.preventDefault();return!1});b(this).on("click",function(k){CM_Tooltip.glossaryTip.show(h,
this);setTimeout(function(){CM_Tooltip.glossaryTip.pos(k)},a.delay+100);return!1})}else if(void 0!==window.cmtt_data&&"1"===window.cmtt_data.tooltip_on_click)b(this).on("click",function(g){CM_Tooltip.glossaryTip.show(h,this);setTimeout(function(){CM_Tooltip.glossaryTip.pos(g)},a.delay+100);return!1});else b(this).on("mouseenter",function(g){clearTimeout(CM_Tooltip.hideTimeoutId);CM_Tooltip.hideTimeoutId=!1;CM_Tooltip.glossaryTip.show(h,this);setTimeout(function(){CM_Tooltip.glossaryTip.pos(g)},a.delay+
100)}).on("focusin",function(g){clearTimeout(CM_Tooltip.hideTimeoutId);CM_Tooltip.hideTimeoutId=!1;CM_Tooltip.glossaryTip.show(h,this);setTimeout(function(){CM_Tooltip.glossaryTip.pos(g)},a.delay+100)}).on("mouseleave focusout",function(){a.close_on_moveout&&!CM_Tooltip.hideTimeoutId&&(clearTimeout(CM_Tooltip.showTimeoutId),CM_Tooltip.hideTimeoutId=setTimeout(function(){CM_Tooltip.glossaryTip.hide()},a.timer+500*a.clickable))})})}};b(function(){setTimeout(function(){b(document).trigger("glossaryTooltipReady")},
5);b(document).ajaxComplete(function(c,a,e){"undefined"!==typeof window.cmtt_data.exclude_ajax&&((new RegExp(window.cmtt_data.exclude_ajax,"g")).test(e.data)||setTimeout(function(){b(document).trigger("glossaryTooltipReady")},1E3))});b(document).on("ninja_table_loaded",function(){b(document).trigger("glossaryTooltipReady")});b(document).on("glossaryTooltipReady",function(){void 0===window.cmtt_data||!window.cmtt_data.cmtooltip||CM_Tools.Modernizr.touch&&"1"===window.cmtt_data.mobile_disable_tooltips||
!CM_Tools.Modernizr.touch&&"1"===window.cmtt_data.desktop_disable_tooltips||(void 0!==window.cmtt_data&&"1"===window.cmtt_data.tooltip_on_click&&(window.cmtt_data.cmtooltip.clickable=!0),CM_Tools.Modernizr.touch&&(window.cmtt_data.cmtooltip.clickable=!0),b("[data-cmtooltip]").glossaryTooltip(window.cmtt_data.cmtooltip))});b(document).on("change",'select[name="cmtt-language-switch"]',function(c){c.preventDefault();c={action:"cmtt_switch_language",language:b(c.target).val(),post_id:window.cmtt_data.post_id,
nonce:window.cmtt_data.nonce_language_switch};b.ajax({url:window.cmtt_data.ajaxurl,method:"POST",data:c,success:function(){window.location.reload()},error:function(a){console.log(a)}})});b(document).on("click","a.cmtt-glossary-theme-toggle",function(){var c=b(this);var a=b(document).find("body");c=c.data("bodyclass");c.length&&a.toggleClass(c)});if("undefined"!==typeof b.fn.dataTable)b(document).on("draw.dt",function(){b(document).trigger("glossaryTooltipReady")});b(document).on("after.ft.paging",
function(){b(document).trigger("glossaryTooltipReady")});b(".cmtt-post-tags").on("click","a",function(){var c=b(this);var a=c.closest(".cmtt-post-tags");var e=a.data("glossary-url");e=b("<form/>",{action:e,method:"post"});e.append(b('<input type="hidden" name="gtags[]" value="'+c.data("tagid")+'" />'));a.append(e);e.submit()});b(".cmtt-taxonomy-single").on("click","a",function(){var c=b(this);var a=c.closest(".cmtt-taxonomy-single");var e=a.data("glossary-url");e=b("<form/>",{action:e,method:"post"});
e.append(b('<input type="hidden" name="'+c.data("taxonomy-name")+'" value="'+c.data("tagid")+'" />'));a.append(e);e.submit()});void 0!==window.cmtt_data&&"1"===window.cmtt_data.doubleclick_api&&(b(document).on("dblclick",function(c){window.cmtt_data.dblclick_timeout=setTimeout(function(){b(c.target);var a=window.getSelection();var e=!1;if(a&&a.rangeCount&&(e=a.getRangeAt(0),e.startContainer!==e.endContainer)){a.modify("extend","backward","word");var d=a.getRangeAt(0).cloneRange();d.setEnd(e.endContainer,
e.endOffset);a.collapseToEnd();a.modify("extend","forward","word");e.setStart(d.startContainer,d.startOffset);e.setEnd(a.getRangeAt(0).endContainer,a.getRangeAt(0).endOffset)}if(e){var h=b("<span>").addClass("glossaryLink temporary");d=e.extractContents();h.append(d);e.insertNode(h[0]);a.removeAllRanges()}a=[h,h.text()];[a,e]=a;CM_Tooltip.api_call(a,e)},300)}),b(document).on("click",".dblclick-save",function(){let c=b(CM_Tooltip.currentElement);var a=c.data("cmtooltip-content");let e=c.data("cmtooltip-nonce");
a={action:"cmtt_api_call_save",term:c.text(),term_content:a,nonce:e};b.post(window.cmtt_data.ajaxurl,a,function(d){c.data("cmtooltip-id",d.term_id);c.data("cmtooltip",d.content);c.attr("data-cmtooltip",d.content);c.data("cmtooltip-content",d.content);c.removeClass("temporary");CM_Tooltip.glossaryTip.hide();CM_Tooltip.glossaryTip.show(d.content,c[0]);setTimeout(function(){CM_Tooltip.glossaryTip.pos()},100);b(document).trigger("glossaryTooltipReady")});CM_Tooltip.glossaryTip.show("Saving...",c[0]);
setTimeout(function(){CM_Tooltip.glossaryTip.pos()},100)}),b(document).on("click",".dblclick-regenerate",function(){let c=b(CM_Tooltip.currentElement),a=c.text();c.data("cmtooltip",null);c.attr("data-cmtooltip",null);c.data("cmtooltip-content",null);c.data("cmtooltip-nonce",null);CM_Tooltip.api_call(c,a,!0)}));CM_Tooltip.api_call=function(c,a,e){b.post(window.cmtt_data.ajaxurl,{action:"cmtt_api_call",selection:a,force:e||!1},function(d){d&&d.full&&2<d.full.length?(c.data("cmtooltip",d.full),c.attr("data-cmtooltip",
d.full),c.data("cmtooltip-content",d.content),c.data("cmtooltip-nonce",d.nonce),CM_Tooltip.glossaryTip.show(d.full,c[0]),setTimeout(function(){CM_Tooltip.glossaryTip.pos()},100),b(document).trigger("glossaryTooltipReady")):CM_Tooltip.glossaryTip.hide()});CM_Tooltip.glossaryTip.show("Loading...",c[0]);setTimeout(function(){CM_Tooltip.glossaryTip.pos()},100)};CM_Tooltip.parseAudioPlayer=function(){var c={defaultVideoWidth:480,defaultVideoHeight:270,videoWidth:-1,videoHeight:-1,audioWidth:"95.5%",audioHeight:30,
startVolume:.8,loop:!1,enableAutosize:!0,features:"playpause progress current duration tracks volume fullscreen".split(" "),alwaysShowControls:!1,iPadUseNativeControls:!1,iPhoneUseNativeControls:!1,AndroidUseNativeControls:!1,alwaysShowHours:!1,showTimecodeFrameCount:!1,framesPerSecond:25,enableKeyboard:!0,pauseOtherPlayers:!0,keyActions:[],isVideo:!1};"undefined"!==typeof _wpmejsSettings&&(c.pluginPath=_wpmejsSettings.pluginPath);b("#tt").find(".cmtt-audio-shortcode").length?"undefined"===typeof b.fn.mediaelementplayer?
console.log('The $ doesn\'t have the function required for displaying the AudioPlayer. \n This is probably because the $ has been reinitialized after the "mediaplayerelement" has already been added.'):b("#tt").find(".cmtt-audio-shortcode").mediaelementplayer(c):"undefined"===typeof b.fn.mediaelementplayer?console.log('The $ doesn\'t have the function required for displaying the AudioPlayer. \n This is probably because the $ has been reinitialized after the "mediaplayerelement" has already been added.'):
b(".glossary-item-audio").find(".cmtt-audio-shortcode").mediaelementplayer(c)};CM_Tooltip.parseAudioPlayer();CM_Tooltip.shareBox=function(){0!==b(".cmtt-social-box").length&&0!==b(".twitter-share-button").length&&("undefined"!==typeof twttr&&"undefined"!==typeof twttr.widgets?twttr.widgets.load():b.getScript("//platform.twitter.com/widgets.js"),"undefined"!==typeof IN?IN.parse():b.getScript("//platform.linkedin.com/in.js"))};CM_Tooltip.shareBox();b(".cmtt-embed-btn").on("click",function(c){c.preventDefault();
c=CM_Tooltip.Utils.overlay(b(document).find(".cmtt-embed-modal"));c.find(".cmtt-embed-modal").show();c.find(".cmtt-embed-modal textarea").on("click",function(){this.select()});b(".cmtt-embed-copy-btn",c).on("click",function(a){a.preventDefault();b(this).parents(".cmtt-embed-modal").find("textarea").trigger("select");document.execCommand("copy")})});CMTT_Footnote.linkClickHandler=function(c){c.preventDefault();var a=b(this);c=a.attr("href");c=c.substring(1,c.length);a=b(a).parent().parent();var e=
b(a).attr("id"),d=e.slice(0,e.length-2);e="#"+d;b("a.cmtt-footnote-deflink").css("background-color","");b(this).css("background-color","#eaf3ff");d=d+"-"+(Math.floor(900*Math.random())+100);b(a).attr("id",d);b(e).find("a").attr("href","#"+d);b(".cmtt-footnote-def").css("background-color","");a=b("."+c);a.length||(a=b("#"+c));a.css("background-color","#eaf3ff");a.length&&b("html, body").animate({scrollTop:a.offset().top-50},500)};CMTT_Footnote.linkBackClickHandler=function(c){c.preventDefault();c=
b(this).attr("href");c=b(c);b(".cmtt-footnote-deflink").css("background-color","");b(".cmtt-footnote-deflink").parent().css("background-color","");b(c).find("sup").css("background-color","#eaf3ff");c.length&&b("html, body").animate({scrollTop:c.offset().top-100},500)};CMTT_Footnote.showMoreHandler=function(c){c.preventDefault();b(this).hide();b(".cmtt-footnote-def.hidden").removeClass("hidden")};b(document).on("click",".cmtt-footnote-deflink",CMTT_Footnote.linkClickHandler);b(document).on("click",
".cmtt-footnote-backlink",CMTT_Footnote.linkBackClickHandler);b(document).on("click",".cmtt-footnote-showmore-btn",CMTT_Footnote.showMoreHandler)});window.CM_Tooltip.Utils={addSingleHandler:function(c,a,e,d){("string"==typeof a?b(a):a).each(function(){var h=b(this);"1"!=h.data(c)&&(h.data(c,"1"),h.on(e,d))})},leftClick:function(c){return function(a){if(!(1<a.which||a.shiftKey||a.altKey||a.metaKey||a.ctrlKey))return c.apply(this,[a]),!1}},toast:function(c,a,e){"string"!=typeof a&&(a="info");"undefined"==
typeof e&&(e=5);var d=b("<div/>",{"class":"cmtt-toast "+a,style:"display:none"});d.text(c);b("body").append(d);d.fadeIn(500,function(){setTimeout(function(){d.fadeOut(500)},1E3*e)})},overlay:function(c){var a=b("<div>",{"class":"cmtt-overlay"}),e=b("<div>",{"class":"cmtt-overlay-content-outer"}),d=b("<div>",{"class":"cmtt-overlay-content"}),h=b("<span>",{"class":"cmtt-overlay-close"});h.html("&times;");b("body").append(a);a.append(e);e.append(d);"string"==typeof c?d.html(c):d.append(c.clone());d.append(h);
a.fadeIn("fast");var g=function(){a.fadeOut("fast",function(){a.remove()})};a.on("click",function(k){b(k.target).hasClass("cmtt-overlay")&&g()});h.on("click",g);b(window).keydown(function(k){27==k.keyCode&&g()});return a}}})(jQuery);
(function(b,c){function a(){if(!d){d=!0;var h=-1!==navigator.appVersion.indexOf("MSIE 10"),g=!!navigator.userAgent.match(/Trident.*rv:11\./),k=c.querySelectorAll("iframe.cm-embedded-content"),t;for(t=0;t<k.length;t++){var p=k[t];if(!p.getAttribute("data-cmsecret")){var q=Math.random().toString(36).substr(2,10);p.src+="#?cmsecret="+q;p.setAttribute("data-secret","__cm__"+q);p.setAttribute("data-cmsecret",q)}if(h||g)q=p.cloneNode(!0),q.removeAttribute("security"),p.parentNode.replaceChild(q,p)}}}var e=
!1,d=!1;c.querySelector&&b.addEventListener&&(e=!0);b.wp=b.wp||{};b.wp.receiveEmbedMessage=null;b.wp.receiveEmbedMessage||(b.wp.receiveEmbedMessage=function(h){var g=h.data;if(null!==g&&(g.secret||g.message||g.value)&&"undefined"!==typeof g.secret&&!/[^a-zA-Z0-9]/.test(g.cmsecret)&&!/[^a-zA-Z0-9]/.test(g.secret)){var k=g.secret.replace("__cm__",""),t=c.querySelectorAll('iframe[data-cmsecret="'+k+'"]'),p=c.querySelectorAll('blockquote[data-cmsecret="'+k+'"]');for(k=0;k<p.length;k++)p[k].style.display=
"none";for(k=0;k<t.length;k++)if(p=t[k],h.source===p.contentWindow){if("height"===g.message){var q=parseInt(g.value,10);1E3<q?q=1E3:200>~~q&&(q=200);p.height=q}if("link"===g.message){q=c.createElement("a");var m=c.createElement("a");q.href=p.getAttribute("src");m.href=g.value;m.host===q.host&&c.activeElement===p&&b.open(g.value,"_blank").focus()}}}},e&&(b.addEventListener("message",b.wp.receiveEmbedMessage,!1),c.addEventListener("DOMContentLoaded",a,!1),b.addEventListener("load",a,!1)))})(window,
document);
