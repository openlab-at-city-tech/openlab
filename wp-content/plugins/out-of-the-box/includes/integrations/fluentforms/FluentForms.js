(function ($) {
    ...
    $('#ff_form_editor_app').on('click', '.outofthebox.open-shortcode-builder', function () {
        ...
        tb_show("Build Shortcode for Form", ajaxurl + '?action=outofthebox-getpopup&' + query + '&type=shortcodebuilder&asuploadbox=1&callback=wpcp_oftb_fluentforms_add_content&TB_iframe=true&height=600&width=800');
