jQuery(function ($) {
  var wc_outofthebox = {
    ...
    addButtons: function () {
      ...
      var button = $('<a href="#TB_inline?height=100%&amp;width=800&amp;inlineId=oftb-embedded" class="button insert-outofthebox thickbox">' + outofthebox_woocommerce_translation.choose_from_dropbox + '</a>');
