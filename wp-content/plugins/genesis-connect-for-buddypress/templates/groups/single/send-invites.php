...
?>
	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form" role="main">
		...
		<div class="main-column">
			...
			<?php do_action( 'bp_before_group_send_invites_list' ); wp_nonce_field( 'groups_invite_uninvite_user', '_wpnonce_invite_uninvite_user' ); ?>
			...
			<?php do_action( 'bp_after_group_send_invites_list' ); wp_nonce_field( 'groups_send_invites', '_wpnonce_send_invites'); ?>
		</div>
		<div class="clear"></div>
