		...
		<?php if ( bp_group_is_member() ) : ?>
			<?php if ( bp_is_edit_topic() ) : ?>
				...
				<div id="edit-topic">
					...
					<?php do_action( 'bp_group_after_edit_forum_topic' ); wp_nonce_field( 'bp_forums_edit_topic' ); ?>
			...
			<?php else : ?>
				...
				<div id="edit-post">
					...
					<?php do_action( 'bp_group_after_edit_forum_post' ); wp_nonce_field( 'bp_forums_edit_post' ); ?>
