...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p><?php _e( 'Click below to select a JPG, GIF or PNG format photo from your computer and then click \'Upload Image\' to proceed.', 'buddypress' );  wp_nonce_field( 'bp_avatar_upload' ); ?></p>
			<p id="avatar-upload">
		...
		<?php elseif ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<h5><?php _e( 'Crop Your New Avatar', 'buddypress' ); wp_nonce_field( 'bp_avatar_cropstore' ); ?></h5>
