...
if ( bp_has_message_threads() ) : ?>
	...
	<?php do_action( 'bp_after_member_messages_pagination' ); do_action( 'bp_before_member_messages_threads' ); ?>
	...
	<?php do_action( 'bp_after_member_messages_threads' ); do_action( 'bp_after_member_messages_options' ); ?>
<?php else: ?>
