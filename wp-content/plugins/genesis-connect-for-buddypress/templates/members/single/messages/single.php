<div id="message-thread" role="main">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<?php endwhile; ?>
		<?php do_action( 'bp_after_message_thread_list' ); do_action( 'bp_before_message_thread_reply' ); ?>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			<div class="message-box">
				...
				<div class="message-content">
					...
					<?php do_action( 'bp_after_message_reply_box' ); wp_nonce_field( 'messages_send_message', 'send_message_nonce' ); ?>
