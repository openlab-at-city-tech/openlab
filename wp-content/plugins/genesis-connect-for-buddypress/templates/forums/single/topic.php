...
?>
		...
		<div id="item-header" role="complementary">
			<?php gconnect_locate_template( array( 'forums/single/forum-header.php' ), true ); ?>
		</div><!-- #item-header -->

		<div id="item-nav">
			<div class="item-list-tabs no-ajax" id="object-nav" role="navigation">
				<ul>
					<?php bp_get_options_nav(); do_action( 'bp_forum_options_nav' ); ?>
				</ul>
			</div>
			<div class="clear"></div>
		</div><!-- #item-nav -->
		...
		<div id="item-body">
			...
			<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
				...
				<?php if ( is_user_logged_in() && bp_get_the_topic_is_last_page() ) : ?>
