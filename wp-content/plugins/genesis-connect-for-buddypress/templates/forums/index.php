...
?>
	...
	<form action="" method="post" id="forums-directory-form" class="dir-form">
		...
		<?php do_action( 'bp_directory_forums_content' ); wp_nonce_field( 'directory_forums', '_wpnonce-forums-filter' ); ?>

	</form>

	<?php do_action( 'bp_after_directory_forums' ); do_action( 'bp_before_new_topic_form' ); ?>
		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<?php if ( bp_is_active( 'groups' ) && bp_has_groups( 'user_id=' . bp_loggedin_user_id() . '&type=alphabetical&max=100&per_page=100' ) ) : ?>
				...
				<form action="" method="post" id="forum-topic-form" class="standard-form">
					...
					<?php do_action( 'groups_forum_new_topic_after' ); wp_nonce_field( 'bp_forums_new_topic' ); ?>
...
do_action( 'bp_after_directory_forums_page' );
gconnect_get_footer();
