...
<style type="text/css">
	...
	#kws_gravityview_info * { text-align: left;}
...
<div id="kws_gravityview_info">
	<div class="aligncenter">
		...
		<img src="<?php echo plugins_url( '/images/money-back-guarantee.jpg', __FILE__ ); ?>" alt="GravityView money-back Guarantee" class="alignright" style="margin: 10px 0 0 10px;" />
		<?php
