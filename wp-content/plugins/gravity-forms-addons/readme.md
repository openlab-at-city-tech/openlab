...
![Approving directory entries is very easy](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-1.png)

###2. When using the Form Editor, your form fields will have a Directory tab for easily modifying your display options.###
![When using the Form Editor, your form fields will have a Directory tab for easily modifying your display options.](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-2.png)

###3. This plugin adds an Edit link to Gravity Form entries###
![This plugin adds an Edit link to Gravity Form entries](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-3.png)

###4. Insert a directory###
![Insert a directory](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-4.png)

###5. How the Gravity Forms widget appears on the widgets page###
![How the Gravity Forms widget appears on the widgets page](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-5.png)

###6. The Gravity Forms Addons settings page, found in the Forms > Directory & Addons menu link###
![The Gravity Forms Addons settings page, found in the Forms > Directory & Addons menu link](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-6.png)

###7. How the Gravity Forms 'Add Fields' boxes look after plugin is activated###
![How the Gravity Forms 'Add Fields' boxes look after plugin is activated](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-7.png)
...
![Go to the post or page where you would like to add the directory.](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-8.png)

###9. Click the "Add Directory" button above the content area.###
![Click the "Add Directory" button above the content area.](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-9.png)

###10. Choose a form from the drop-down menu and configure settings as you would like them.###
![Choose a form from the drop-down menu and configure settings as you would like them.](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-10.png)

###11. Click "Insert Directory". A "shortcode" should appear in the content editor that looks similar to <code style="font-size:1em;">[directory form="#"]</code>###
![Click "Insert Directory". A "shortcode" should appear in the content editor that looks similar to <code style="font-size:1em;">[directory form="#"]</code>](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-11.png)

###12. Save the post or page###
![Save the post or page](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-12.png)
...
![Edit the Gravity Forms form you'd like to configure a Directory for](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-13.png)

###14. Click "Directory Columns" In the Form Editor toolbar (near the top-center of the page)###
![Click "Directory Columns" In the Form Editor toolbar (near the top-center of the page)](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-14.png)

###15. Drag & drop the fields in the order you'd like them to appear in the directory###
![Drag & drop the fields in the order you'd like them to appear in the directory](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-15.png)

	* Drag from the right ("Hidden Columns") side to the left ("Visible Columns") side.
###16. Click the "Save" button###
![Click the "Save" button](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-16.png)

###17. Voila!###
![Voila!](http://s.wordpress.org/extend/plugins/gravity-forms-directory/screenshot-17.png)
