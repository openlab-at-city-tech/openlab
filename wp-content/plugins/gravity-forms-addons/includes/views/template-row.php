...
if ( is_array( $leads ) && ! empty( $leads ) && count( $leads ) > 0 && $lead_count > 0 ) {
	...
	?>
	<tr>
		<td colspan="<?php echo count( $columns ); ?>" class="noresults" style="padding:20px;">
								<?php
