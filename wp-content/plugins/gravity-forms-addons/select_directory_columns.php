	...
	public static function select_columns_page() {
		...
		<head>
			...
			<script type="text/javascript">
				...
				jQuery( document ).ready( function ( $ ) {
					...
					$( "#sortable_available, #sortable_selected" ).sortable( {
					...
					$( ".sortable_connected li" ).hover( function () {
		...
		<div id="wrapper">
			...
			array_push( $form["fields"], array(
				"id"    => "id",
				"label" => esc_html__( "Entry Id", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "date_created",
				"label" => esc_html__( "Entry Date", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "ip",
				"label" => esc_html__( "User IP", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "source_url",
				"label" => esc_html__( "Source Url", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "payment_status",
				"label" => esc_html__( "Payment Status", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "transaction_id",
				"label" => esc_html__( "Transaction Id", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "payment_amount",
				"label" => esc_html__( "Payment Amount", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "payment_date",
				"label" => esc_html__( "Payment Date", "gravity-forms-addons" ),
			) );
			array_push( $form["fields"], array(
				"id"    => "created_by",
				"label" => esc_html__( "User", "gravity-forms-addons" ),
			) );
			...
			<div class="gcolumn_wrapper">
				<div class="gcolumn_container_left">
					<div
						class="gform_select_column_heading"><?php esc_html_e( "Visible Columns", "gravity-forms-addons" ); ?></div>
				...
				<div class="gcolumn_container_right" id="available_column">
					<div
						class="gform_select_column_heading"> <?php esc_html_e( "Hidden Columns", "gravity-forms-addons" ); ?></div>
