...
<table class="form-table">
	<tbody>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slide Title Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set slide title color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p3" data-tooltip="#s3"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slide Title Background Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set slide title background color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p4" data-tooltip="#s4"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slide Description Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set slide description color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p6" data-tooltip="#s6"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slide Description Background Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set slide description background color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p7" data-tooltip="#s7"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Auto play Slider Speed', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Set your desired slider speed of slides. Default speed is 5 Second.', 'ultimate-responsive-image-slider'); ?>
					<!--<a href="#" id="p10" data-tooltip="#s10"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>-->
				</p>
			</td>
		</tr>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Distance Between Slide', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Set a gap between all slides. Range 0 to 25. Works when Slide Transition setting selected to Slide.', 'ultimate-responsive-image-slider'); ?>&nbsp;
					<a href="#" id="p12" data-tooltip="#s12"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Selected Thumbnail Style Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set on selected thumbnail style color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p16" data-tooltip="#s16"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Thumbnail Resize', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slider Width', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slider Height', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Slide Scale Mode', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<select name="wl-l3-slider_scale_mode" id="wl-l3-slider_scale_mode" class="standard-dropdown">
					<optgroup label="Select Slider Scale Mode">
						<option value="cover" <?php if($WRIS_L3_Slider_Scale_Mode == "cover" ) { echo esc_attr("selected=selected"); } ?>><?php esc_html_e('Cover', 'ultimate-responsive-image-slider'); ?></option>
						<option value="contain" <?php if($WRIS_L3_Slider_Scale_Mode == "contain" ) { echo esc_attr("selected=selected"); } ?>><?php esc_html_e('Contain', 'ultimate-responsive-image-slider'); ?></option>
						<option value="exact" <?php if($WRIS_L3_Slider_Scale_Mode == "exact" ) { echo esc_attr("selected=selected"); } ?>><?php esc_html_e('Exact', 'ultimate-responsive-image-slider'); ?></option>
						<option value="none" <?php if($WRIS_L3_Slider_Scale_Mode == "none" ) { echo esc_attr("selected=selected"); } ?>><?php esc_html_e('None', 'ultimate-responsive-image-slider'); ?></option>
					</optgroup>
				</select>
				<p class="description">
					<?php esc_html_e('COVER will scale and crop the image so that it fills the entire slide.', 'ultimate-responsive-image-slider'); ?><br />
					<?php esc_html_e('CONTAIN will keep the entire image visible inside the slide.', 'ultimate-responsive-image-slider'); ?><br />
					<?php esc_html_e('EXACT will match the size of the image to the size of the slide.', 'ultimate-responsive-image-slider'); ?><br />
					<?php esc_html_e('NONE will leave the image to its original size.', 'ultimate-responsive-image-slider'); ?>
					<!--<a href="#" id="p20" data-tooltip="#s20"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>-->
				</p>
			</td>
		</tr>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Navigation Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set navigation arrow and full screen icon color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p23" data-tooltip="#s23"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Navigation Bullets Color', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Select a color to set navigation bullets color.', 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p25" data-tooltip="#s25"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php esc_html_e("Fonts", 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e("Choose a font to apply on slide title and description.", 'ultimate-responsive-image-slider'); ?>
					<a href="#" id="p27" data-tooltip="#s27"><?php esc_html_e('Preview', 'ultimate-responsive-image-slider'); ?></a>
				</p>
		...
		<tr id="L3">
			<th scope="row"><label><?php esc_html_e('Custom CSS', 'ultimate-responsive-image-slider'); ?></label></th>
			<td>
				...
				<p class="description">
					<?php esc_html_e('Enter any custom CSS you want to apply on this slider into text area filed.', 'ultimate-responsive-image-slider'); ?><br>
				</p>
