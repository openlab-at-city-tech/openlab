...
final class EPKB_Basic_Layout_Block extends EPKB_Abstract_Block {
	...
	protected function get_this_block_inline_styles( $block_attributes ) {
		...
		$output .=
			...
			$block_selector . ' ' . '#epkb-content-container .epkb-category-level-2-3__cat-icon {
		        font-size: ' . (intval($block_attributes['section_subcategory_typography_controls']['font_size']) * 0.75) . 'px !important;
			}' .
