...
export default function AdvancedSearchBlockEdit({ attributes, setAttributes, name }) {

	// this should never happen except during development
	// and indicates a critical issue
	if (!epkb_advanced_search_block_ui_config) {
		return (
			<>
	...
	return (
		<EpkbInspectorControls
			block_ui_config={epkb_advanced_search_block_ui_config}
