...
export default function GridLayoutBlockEdit({ attributes, setAttributes, name }) {

	// this should never happen except during development
	// and indicates a critical issue
	if (!epkb_grid_layout_block_ui_config) {
		return (
			<>
	...
	return (
		<EpkbInspectorControls
			block_ui_config={epkb_grid_layout_block_ui_config}
