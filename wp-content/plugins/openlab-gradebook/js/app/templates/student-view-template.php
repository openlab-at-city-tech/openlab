...
<td class="student<%= mobile_styles %>">
    <span class="column-frame-wrapper">
...
<td class="student<%= mobile_styles %>"><span class="header-span-wrapper"><span data-toggle="tooltip" data-placement="top" title='<%= student.get("last_name") %>'><%= student.get("last_name") %></span></span></td>
<td class="student<%= mobile_styles %>"><span class="header-span-wrapper"><span data-toggle="tooltip" data-placement="top" title='<%= student.get("user_login") %>'><%= student.get("user_login") %></span></span></td>
