...
function enqueue_oplb_gradebook_scripts($hook) {
    ...
    wp_register_script('init_gradebookjs', $app_base . '/init_gradebook.js', array('jquery', 'media-views'), '0.0.2.4', true);
    ...
    if ($hook == "toplevel_page_oplb_gradebook" || $hook == 'gradebook_page_oplb_gradebook_settings') {
        ...
        wp_register_script('requirejs', $app_base . '/require.js', array('jquery', 'media-views'), '0.0.2.4', true);
