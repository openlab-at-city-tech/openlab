...
<div class="bookly-form-group">
    ...
    <div>
        <input id="bookly-email-confirm-<?php echo $form_id ?>" class="bookly-js-user-email-confirm" maxlength="255" type="text" value="<?php echo esc_attr( $userData->getEmailConfirm() ) ?>"/>
    </div>
