 ...
 * @method static bool sendToStaff( bool $sent, Lib\Entities\Notification $notification, Lib\Notifications\Assets\Base\Codes $codes, Lib\Notifications\Assets\Base\Attachments $attachments, $reply_to, NotificationList|null $queue = null )
 */
