...
<input type="hidden" name="form-notifications">
    <div class="form-group">
        ...
        <div class="form-row">
            ...
            <div class="col-auto">
                <div class="btn-group">
                    <button class="btn btn-success" id="send_test_sms" data-action="save-administrator-phone"><?php esc_html_e( 'Save administrator phone', 'bookly' ) ?></button>
                </div>
            </div>
        </div>
...
<form method="post" action="<?php echo Common::escAdminUrl( $self::pageSlug() ) ?>">
    <div class="row">
        ...
        <div class="col-md-8 form-row justify-content-end pr-2">
            ...
            <?php Dialogs\TableSettings\Dialog::renderButton( Tables::WHATSAPP_NOTIFICATIONS, 'BooklyL10n' ) ?>
        </div>
    </div>
