    ...
    $.extend(pageInput.prototype, {
        _constructor: function() {
            let dt = this.s.dt,
                ...
                $container = $('<div>', {class: 'input-group ml-3 bookly-page-input'})
                    .append($input)
                    .append($('<div>', {class: 'input-group-append'}).append($btn));
            $container.toggle(dt.page.info().pages >= config.whenPages);
            $('.dataTables_paginate', $(dt.table().container())).parent().addClass('d-flex');
            $('.dataTables_paginate', $(dt.table().container()))
                .after(
                    $container
                );
