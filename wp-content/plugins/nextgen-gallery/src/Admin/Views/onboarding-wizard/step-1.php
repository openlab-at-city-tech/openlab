...
?>
	<div class="nextgen-gallery-onboarding-form-step nextgen-gallery-onboarding-form-step-active" id="general">
		...
		<div class="nextgen-gallery-onboarding-wizard-body">
			<div class="steps"><?php esc_html_e( 'Step - 1 of 5', 'nggallery' ); ?></div>
			<div class="nextgen-gallery-onboarding-settings-row no-padding no-border">
				<div class="settings-name">
					<h2><?php esc_html_e( 'What best describes you?', 'nggallery' ); ?></h2>
					<div class="name small-margin">
					</div>
					<div class="nextgen-gallery-onboarding-description"><?php esc_html_e( 'Tell us a bit about this website to help us craft the perfect experience for you.', 'nggallery' ); ?></div>
				</div>
					...
					<div class="nextgen-gallery-onboarding-input">
						<div class="nextgen-gallery-options">
							<div class="nextgen-gallery-option">
								...
								<label for="photographer"><?php esc_html_e( 'Photographer', 'nggallery' ); ?></label>
							</div>
							<div class="nextgen-gallery-option">
								<input type="radio" required id="online-store" name="eow[_user_type]" value="online-store">
								<label for="online-store"><?php esc_html_e( 'Online Store', 'nggallery' ); ?></label>
							</div>
							<div class="nextgen-gallery-option">
								<input type="radio" required id="business_store_owner" name="eow[_user_type]" value="corporate-website">
								<label for="business_store_owner"><?php esc_html_e( 'Business Owner', 'nggallery' ); ?></label>
							</div>
							<div class="nextgen-gallery-option">
								<input type="radio" required id="designer-artist" name="eow[_user_type]" value="designer-artist">
								<label for="designer-artist"><?php esc_html_e( 'Designer / Artist', 'nggallery' ); ?></label>
							</div>
							<div class="nextgen-gallery-option">
								<input type="radio" required id="blogger" name="eow[_user_type]" value="blogger">
								<label for="blogger"><?php esc_html_e( 'Blogger', 'nggallery' ); ?></label>
							</div>
							<div class="nextgen-gallery-option">
								<input type="radio" required id="something_else" name="eow[_user_type]" value="other">
								<label for="something_else"><?php esc_html_e( 'Other', 'nggallery' ); ?></label>
							</div>
						</div>
						<div class="nextgen-gallery-options" id="others_div" style="display: none;">
							<input type="text" id="others" name="eow[_others]" value="<?php echo esc_attr( $onboarding->get_onboarding_data( '_others' ) ); ?>" placeholder="<?php esc_attr_e( 'What best describes you?', 'nggallery' ); ?>">
					</div>
					</div>
				</div>
				<div class="settings-name" id="ngg-pro-upsell" style="display: none;">
					<div class="nextgen-gallery-onboarding-description small-margin">
						...
						<a target="_blank" href="<?php echo esc_url( 'http://www.imagely.com/lite/?utm_source=WordPress&utm_campaign=nextgen-galleryliteplugin&utm_medium=nextgen-gallery-wizard-welcome&utm_content=' . \Imagely\NGG\Admin\App::get_utm_version() ); ?>" ><?php esc_html_e( 'Upgrade Now', 'nggallery' ); ?>
					...
					<div class="nextgen-gallery-onboarding-input">
						<div class="nextgen-gallery-options">
							<div class="nextgen-gallery-option width-20">
								<label for="email_address"><?php esc_html_e( 'Email Address', 'nggallery' ); ?></label>
							</div>
					...
					<div class="nextgen-gallery-onboarding-input-container" style="margin-top: -20px;">
						<div class="nextgen-gallery-onboarding-input">
							<div class="nextgen-gallery-options email_opt_in">
								...
								<label for="email_opt_in"><?php esc_html_e( 'I agree to receive important communications from NextGEN Gallery.', 'nggallery' ); ?></label>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="nextgen-gallery-options nextgen-gallery-checkbox">
							<label class="nextgen-gallery-toggle">
								...
								<span class="description " >
									<?php esc_html_e( 'Help us better understand our users and their website needs.', 'nggallery' ); ?>
								</span>
							</label>
								<div class="tooltip-container" >
									...
									<span class="tooltip-text"><?php esc_html_e( 'This will let us monitor the usage of your galleries and insights which will be used to improve the NextGEN Gallery', 'nggallery' ); ?></span>
								</div>
						</div>
					</div>
				</div>
		...
		<div class="nextgen-gallery-onboarding-wizard-footer">
				<div class="go-back"><a href="#welcome" class="nextgen-gallery-onboarding-wizard-back-btn" id="nextgen-gallery-onboarding-back-to-welcome">←&nbsp;<?php esc_html_e( 'Go back', 'nggallery' ); ?></a></div>
				<div class="spacer"></div><input type="submit" data-next="1" class="btn nextgen-gallery-onboarding-wizard-primary-btn nextgen-gallery-onboarding-btn-next " id="save-opt-in" value="<?php esc_attr_e( 'Save and Continue', 'nggallery' ); ?>&nbsp; →"/>
		</div>
		</form>
	</div>
<script>
