...
<div class="nextgen-gallery-onboarding-form-step nextgen-gallery-wizard-success nextgen-gallery-onboarding-step-5" id="resources">
	<div class="nextgen-gallery-onboarding-wizard-body">
		<div class="steps"><?php esc_html_e( 'Step - 5 of 5', 'nggallery' ); ?></div>
		<div class="nextgen-gallery-onboarding-settings-row no-border ">
			<div class="settings-name">
				<h2><?php esc_html_e( 'Congratulations!', 'nggallery' ); ?><br/>
					<?php esc_html_e( 'Your system is all set up, and you\'re ready to create your first gallery.', 'nggallery' ); ?>
				</h2>
				<div class="name small-margin">
				</div>
				<div class="nextgen-gallery-onboarding-description"><?php esc_html_e( 'Need Help? Here’s what to do next', 'nggallery' ); ?></div>
			</div>
		...
		<div class="actions">
			<div class="">
				...
				<div class="content">
					<div><a target="_blank" href="<?php echo esc_url( 'https://www.imagely.com/docs/nextgen-gallery/?utm_source=WordPress&utm_campaign=nextgen-galleryliteplugin&utm_medium=nextgen-gallery-wizard-success&utm_content=' . \Imagely\NGG\Admin\App::get_utm_version() ); ?>" title="<?php esc_attr_e( 'Read our Step by Step Guide to Create and Share your Gallery', 'nggallery' ); ?>" ><?php esc_html_e( 'Read Our Step-by-Step Guide to Create and Share Your Gallery', 'nggallery' ); ?></a></div>
				</div>
			</div>
			<div class="">
				<div class="icon">
				...
				<div class="content">
					<div><a target="_blank" href="<?php echo esc_url( 'https://www.wpbeginner.com/?utm_source=WordPress&utm_campaign=nextgen-galleryliteplugin&utm_medium=nextgen-gallery-wizard-success' ); ?>" title="<?php esc_attr_e( 'Learn WordPress Tutorials', 'nggallery' ); ?>" ><?php esc_html_e( 'Learn WordPress Tutorials', 'nggallery' ); ?></a></div>
				</div>
			</div>
		</div>
	</div>
	<div class="nextgen-gallery-onboarding-wizard-footer">
		<div class="go-back"><a href="#summary" data-prev="3" class="nextgen-gallery-onboarding-wizard-back-btn nextgen-gallery-onboarding-btn-prev" id="" >←&nbsp;<?php esc_html_e( 'Go back', 'nggallery' ); ?></a></div>
		<div class="spacer"></div>
		<a class="btn btn-transparent" href="<?php echo esc_url( admin_url( '/admin.php?page=imagely-settings' ) ); ?>"><?php esc_html_e( 'Go to settings', 'nggallery' ); ?></a>
		<a class="btn nextgen-gallery-onboarding-wizard-primary-btn" href="<?php echo esc_url( admin_url( '/admin.php?page=imagely&tab=general' ) ); ?>"><?php esc_html_e( 'Create your first gallery', 'nggallery' ); ?>&nbsp; →</a>
	</div>
</div>
