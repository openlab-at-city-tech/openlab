<tr>
	...
	<td>
		<input type="radio"
				...
				value="1"
			<?php checked( 1, $value ); ?>/>
		<label for="<?php print $display_type_name . '_' . $name; ?>"><?php esc_html_e( 'Yes', 'nggallery' ); ?></label>
		&nbsp;
		<input type="radio"
				...
				value="0"
			<?php checked( 0, $value ); ?>/>
		<label for="<?php print $display_type_name . '_' . $name; ?>_no"><?php esc_html_e( 'No', 'nggallery' ); ?></label>
	</td>
</tr>
