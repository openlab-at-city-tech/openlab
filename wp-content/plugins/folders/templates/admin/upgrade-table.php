...
$options = [
    '1_year' => [
        ...
        'plan_type' => esc_html__('Billed Yearly', 'folders'),
        'postfix'   => esc_html__('/Year', 'folders'),
        'plans' => [
            [
                'price'     => 69,
                'desc'      => '',
                'month'     => esc_html__('Less than $5.8/mo', 'folders'),
                'link'      => $proURL."52",
                'websites'  => esc_html__('1 Website', 'folders')
            ],[
                'price'     => 149,
                'desc'      => esc_html__('Save $196', 'folders'),
                'month'     => esc_html__('Less than $12.4/mo', 'folders'),
                'link'      => $proURL."55",
                'websites'  => esc_html__('5 Websites', 'folders')
            ],[
                'price'     => 249,
                'desc'      => esc_html__('Save $3,000+', 'folders'),
                'month'     => esc_html__('Less than $20.8/mo', 'folders'),
                'link'      => $proURL."58",
                'websites'  => esc_html__('50 Websites', 'folders')
            ],[
                'price'     => 489,
                'desc'      => esc_html__('Save >95%', 'folders'),
                'month'     => esc_html__('Less than $40.8/mo', 'folders'),
                'link'      => $proURL."61",
                'websites'  => esc_html__('500 Websites', 'folders')
            ],[
                'price'     => 669,
                'desc'      => esc_html__('Save >95%', 'folders'),
                'month'     => esc_html__('Less than $55.8/mo', 'folders'),
                'link'      => $proURL."64",
                'websites'  => esc_html__('1000 Websites', 'folders')
            ]
        ]
    ],
    '2_years' => [
        'title' => esc_html__('2 Year', 'folders'),
        'plan_type' => esc_html__('Billed Yearly after 2 Years', 'folders'),
        'postfix'   => esc_html__('/2 Years', 'folders'),
        'plans' => [
            [
                'price'     => 99,
                'desc'      => esc_html__('Save $39', 'folders'),
                'month'     => esc_html__('Less than $4.1/mo', 'folders'),
                'link'      => $proURL."53",
                'websites'  => esc_html__('1 Website', 'folders')
            ],[
                'price'     => 229,
                'desc'      => esc_html__('Save $461', 'folders'),
                'month'     => esc_html__('Less than $9.5/mo', 'folders'),
                'link'      => $proURL."56",
                'websites'  => esc_html__('5 Websites', 'folders')
            ],[
                'price'     => 389,
                'desc'      => esc_html__('Save $5,000+', 'folders'),
                'month'     => esc_html__('Less than $16.2/mo', 'folders'),
                'link'      => $proURL."59",
                'websites'  => esc_html__('50 Websites', 'folders')
            ],[
                'price'     => 729,
                'desc'      => esc_html__('Save >95%', 'folders'),
                'month'     => esc_html__('Less than $30.4/mo', 'folders'),
                'link'      => $proURL."62",
                'websites'  => esc_html__('500 Websites', 'folders')
            ],[
                'price'     => 999,
                'desc'      => esc_html__('Save >95%', 'folders'),
                'month'     => esc_html__('Less than $41.6/mo', 'folders'),
                'link'      => $proURL."65",
                'websites'  => esc_html__('1000 Websites', 'folders')
            ]
        ]
    ...
    'lifetime' => [
        ...
        'plan_type' => esc_html__('For Lifetime', 'folders'),
        'postfix'   => esc_html__('/Lifetime', 'folders'),
        'plans' => [
            [
                'price'     => 175,
                'desc'      => esc_html__('Save $170', 'folders'),
                'month'     => esc_html__('Lifetime License 🚀', 'folders'),
                'link'      => $proURL."54",
                'websites'  => esc_html__('1 Website', 'folders')
            ],[
                'price'     => 389,
                'desc'      => esc_html__('Save $1,336', 'folders'),
                'month'     => esc_html__('Lifetime License 🚀', 'folders'),
                'link'      => $proURL."57",
                'websites'  => esc_html__('5 Websites', 'folders')
            ],[
                'price'     => 669,
                'desc'      => esc_html__('Save $10,000+', 'folders'),
                'month'     => esc_html__('Lifetime License 🚀', 'folders'),
                'link'      => $proURL."60",
                'websites'  => esc_html__('50 Websites', 'folders')
            ],[
                        ...
                        <div class="plan-row total-col-<?php echo esc_attr(count($options)) ?>">
                            <div class="plan-col first-col plan-data">
                                <div class="plan-plugin-name">
                                    <div class="plugin-title">Folders</div>
                                    ...
                                    <div class="plan-col plan-detail plan-info" data-plan="<?php echo esc_attr($key) ?>">
                                        ...
                                        <div class="app-plan-top">
                                            ...
                                            <div class="plan-button">
                                                <a class="purchase-link" href="<?php echo esc_attr($option['plans']['0']['link']) ?>" target="_blank"><?php esc_html_e('Buy now', 'folders') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php }
