		...
		<div class="wrap anthologize">
			...
			<?php
				$sponsors = array(
					array(
						'name' => 'Jean Amaral',
						'link' => 'http://www.jamaral.info/',
					),
					array(
						'name' => 'Jared Bennett',
						'link' => 'http://commons.hwdsb.on.ca/',
					),
					array(
						'name' => 'Sheila Brennan',
						'link' => 'http://lotfortynine.org/',
					),
					array(
						'name' => 'Martha Burtis',
						'link' => 'http://wrapping.marthaburtis.net/',
					),
					array(
						'name' => 'Mel Choyce',
						'link' => 'http://choycedesign.com/',
					),
					array(
						'name' => 'Jay Collier',
						'link' => 'http://jaycollier.net',
					),
					array(
						'name' => 'Catherine Derecki',
						'link' => '',
					),
					array(
						'name' => 'Sherman Dorn',
						'link' => 'http://shermandorn.com',
					),
					array(
						'name' => 'Jack Dougherty',
						'link' => 'http://internet2.trincoll.edu/facProfiles/Default.aspx?fid=1004266',
					),
					array(
						'name' => 'Andrew Famiglietti',
						'link' => 'http://copyvillain.org/',
					),
					array(
						'name' => 'Matthew K Gold',
						'link' => '',
					...
					array(
						'name' => 'Kathie Gossett',
						'link' => 'http://www.kathiegossett.com/',
					),
					array(
						'name' => 'Jim Groom',
						'link' => 'http://bavatuesdays.com',
					),
					array(
						'name' => 'Josh Honn',
						'link' => 'http://joshhonn.com/',
					),
					array(
						'name' => 'Helen Hou-Sand&iacute;',
						'link' => 'http://helenhousandi.com/',
					),
					array(
						'name' => 'Sarah Hovde',
						'link' => '',
					...
					array(
						'name' => 'Tonya Howe',
						'link' => 'http://cerisia.cerosia.org/',
					),
					array(
						'name' => 'Cyri Jones',
						'link' => 'http://24posts.com/',
					),
					array(
						'name' => 'Korey Jackson',
						'link' => 'http://koreybjackson.com/',
					),
					array(
						'name' => 'Aaron Jorbin',
						'link' => 'http://aaron.jorb.in/',
					),
					array(
					...
					array(
						'name' => 'Sharon Leon',
						'link' => 'http://www.6floors.org/bracket/',
					),
					array(
						'name' => 'Tammie Lister',
						'link' => 'http://logicalbinary.com/',
					),
					array(
						'name' => 'Eric A Mann',
					...
					array(
						...
						'link' => 'http://wordsforwp.com',
					),
					array(
						'name' => 'Beno&icirc; Melan&ccedil;on',
						'link' => 'http://mapageweb.umontreal.ca/melancon/',
					),
					array(
						'name' => 'Patrick Murray-John',
						'link' => 'http://hackingthehumanities.org/',
					),
					array(
						'name' => 'Rebecca Onion',
						'link' => '',
					...
					array(
						'name' => 'David Parry',
						'link' => 'http://outsidethetext.com',
					),
					array(
						'name' => 'PressCrew',
						'link' => 'http://presscrew.com',
					),
					array(
						'name' => 'Quint Rahaman',
						'link' => '',
					...
					array(
						...
						'link' => 'http://shaynesanderson.com',
					),
					array(
						'name' => 'Paul Schacht',
						'link' => 'http://www.geneseo.edu/~schacht/',
					),
					array(
						'name' => 'Tom Scheinfeldt',
						'link' => 'http://foundhistory.org/',
					),
					array(
						'name' => 'Daniel Schulz-Jackson',
						'link' => '',
					),
					array(
						'name' => 'Michael Branson Smith',
						'link' => 'http://michaelbransonsmith.net/',
					),
					array(
						'name' => 'Kerry Thompson',
						'link' => '',
					...
					array(
						'name' => 'Jane Wells',
						'link' => 'http://jane.wordpress.com/',
					),
					array(
						'name' => 'K.Adam White',
						'link' => 'http://kadamwhite.com/',
					),
					array(
						'name' => 'Brad Williams',
						'link' => 'http://strangework.com/',
					),
					array(
						'name' => 'George H. Williams',
						'link' => 'http://georgehwilliams.net/',
					),
				);
