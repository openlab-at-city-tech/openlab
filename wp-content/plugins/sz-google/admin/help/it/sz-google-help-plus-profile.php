...
<p>Se hai un profilo su Google+ e vuoi inserirlo sul tuo sito o integrarlo in un badge autore allora questo è 
lo strumento adatto. Il badge del profilo può essere inserito in differenti metodi e personalizzato tramite 
opzioni messe a disposizione dal plugin stesso. Il badge viene inserito tramite un iframe, in questa maniera vengono
rispettate tutte le caratteristiche definite da google.</p>

<p>Per inserire questo componente dovete usare lo shortcode <b>[sz-gplus-profile]</b>, se invece desiderate utilizzarlo in una sidebar 
...
anche un'altra possibilità, infatti basta utilizzare una funzione PHP chiamata <b>szgoogle_gplus_get_badge_profile(\$options)</b>.</p>
