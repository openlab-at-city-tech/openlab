...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_url ?>"><?php echo ucfirst(__('URL video','sz-google')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals"><input class="widefat" id="<?php echo $ID_url ?>" name="<?php echo $NAME_url ?>" type="text" value="<?php echo $VALUE_url ?>" placeholder="<?php echo __('insert URL for youtube video','sz-google') ?>"/></td>
</tr>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('schemaorg','sz-google')) ?>:</label></td>
	<td colspan="1" class="sz-cell-vals"><input type="radio" name="<?php echo $NAME_schemaorg ?>" value="y" <?php if ($VALUE_schemaorg == 'y') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('yes','sz-google')) ?></td>
	<td colspan="1" class="sz-cell-vals"><input type="radio" name="<?php echo $NAME_schemaorg ?>" value="n" <?php if ($VALUE_schemaorg != 'y') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('no' ,'sz-google')) ?></td>
</tr>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_start ?>"><?php echo ucfirst(__('start (secs)','sz-google')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals"><input class="widefat" id="<?php echo $ID_start ?>" name="<?php echo $NAME_start ?>" type="number" step="1" min="0" value="<?php echo $VALUE_start ?>" placeholder="<?php echo __('insert value in seconds','sz-google') ?>"/></td>
</tr>

<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_end ?>"><?php echo ucfirst(__('end (secs)','sz-google')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals"><input class="widefat" id="<?php echo $ID_end ?>" name="<?php echo $NAME_end ?>" type="number" step="1" min="0" value="<?php echo $VALUE_end ?>" placeholder="<?php echo __('insert value in seconds','sz-google') ?>"/></td>
</tr>
