...
<table id="SZGoogleWidgetPlusShare" class="sz-google-table-widget">
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		if (typeof(szgoogle_switch_hidden_onload) == 'function') { szgoogle_switch_hidden_onload('SZGoogleWidgetPlusShare'); }
