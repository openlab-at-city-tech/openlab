...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_urltype ?>"><?php echo ucfirst(__('type','sz-google')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals">
		<select class="sz-google-switch-hidden widefat" id="<?php echo $ID_urltype ?>" name="<?php echo $NAME_urltype ?>" onchange="szgoogle_switch_hidden_onchange(this);" data-open="1" data-switch="sz-google-switch-url">
			<option value="1" <?php echo selected("1",$VALUE_urltype) ?>><?php echo __('URL for page or profile','sz-google') ?></option>
			<option value="2" <?php echo selected("2",$VALUE_urltype) ?>><?php echo __('configuration page','sz-google') ?></option>
			<option value="3" <?php echo selected("3",$VALUE_urltype) ?>><?php echo __('configuration profile','sz-google') ?></option>
		</select>
	</td>
</tr>
...
<tr class="sz-google-switch-url sz-google-hidden">
	...
	<td colspan="2" class="sz-cell-vals"><input class="sz-upload-image-url widefat" id="<?php echo $ID_url ?>" name="<?php echo $NAME_url ?>" type="text" value="<?php echo $VALUE_url ?>" placeholder="<?php echo __('insert destination URL','sz-google') ?>"/></td>
</tr>
...
<tr>
	...
	<td colspan="2" class="sz-cell-vals">
		<select class="widefat" id="<?php echo $ID_size ?>" name="<?php echo $NAME_size ?>">
			...
			<option value="large"  <?php echo selected("large" ,$VALUE_size) ?>><?php echo __('size large' ,'sz-google') ?></option>
		</select>
	</td>
</tr>
