...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_method ?>"><?php echo ucfirst(__('profile','sz-google')) ?>:</label></td>
...
<tr class="sz-google-switch-specific sz-google-hidden">
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_specific ?>"><?php echo ucfirst(__('profile ID','sz-google')) ?>:</label></td>
...
<!-- WIDGETS (Field to specify the parameter autore) -->
<tr class="sz-google-row-tab sz-google-row-tab-1">
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('author','sz-google')) ?>:</label></td>
	<td colspan="1" class="sz-cell-vals"><input type="radio" name="<?php echo $NAME_author ?>" value="true"  <?php if ($VALUE_author == 'true') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('yes','sz-google')) ?></td>
	<td colspan="1" class="sz-cell-vals"><input type="radio" name="<?php echo $NAME_author ?>" value="false" <?php if ($VALUE_author != 'true') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('no','sz-google')) ?></td>
</tr>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		if (typeof(szgoogle_switch_select_onload) == 'function') { szgoogle_switch_select_onload('SZGoogleWidgetPlusProfile'); }
