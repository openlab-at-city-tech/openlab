...
<tr>
	...
	<td colspan="1" class="sz-cell-vals"><input class="sz-upload-image-url widefat" id="<?php echo $ID_url ?>" name="<?php echo $NAME_url ?>" type="text" value="<?php echo $VALUE_url ?>" placeholder="<?php echo __('insert URL file to save','sz-google') ?>"/></td>
...
<tr class="sz-google-switch-display sz-google-hidden">
	...
	<td colspan="2" class="sz-cell-vals"><textarea class="widefat" rows="3" cols="20" id="<?php echo $ID_text ?>" name="<?php echo $NAME_text ?>" placeholder="<?php echo __('insert text for badge','sz-google') ?>"><?php echo $VALUE_text ?></textarea></td>
</tr>
