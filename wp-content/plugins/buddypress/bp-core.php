...
//#wds - changed function gmmktime to mktime in line below to get correct last activity time
		$older_date = mktime( (int)$time_chunks[1], (int)$time_chunks[2], (int)$time_chunks[3], (int)$date_chunks[1], (int)$date_chunks[2], (int)$date_chunks[0] );
		$older_date_gmt = gmmktime( (int)$time_chunks[1], (int)$time_chunks[2], (int)$time_chunks[3], (int)$date_chunks[1], (int)$date_chunks[2], (int)$date_chunks[0] );
	}
	...
	if ($since < 0) {
		$since = $newer_date - $older_date_gmt;
	}
