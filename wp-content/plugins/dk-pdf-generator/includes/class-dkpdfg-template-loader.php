...
if ( ! class_exists( 'DKPDFG_Template_Loader' ) )  {

	class DKPDFG_Template_Loader {

		protected $filter_prefix = 'dkpdfg';
		protected $theme_template_directory = 'dkpdfg';
		protected $plugin_directory = DKPDFG_PLUGIN_DIR;
