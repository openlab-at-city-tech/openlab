            ...
            <div class="sbi-fb-inf-cnt">
                ...
                <div class="sbi-fb-inf-img">
                    <svg width="125" height="119" viewBox="0 0 125 119" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M38.7173 42.0584C38.7197 41.9204 38.8336 41.8104 38.9716 41.8128L56.469 42.1182C56.607 42.1206 56.717 42.2345 56.7146 42.3725L56.4092 59.8699C56.4067 60.0079 56.2929 60.1179 56.1548 60.1155L38.6575 59.8101C38.5194 59.8077 38.4095 59.6938 38.4119 59.5557L38.7173 42.0584Z"
                              fill="#434960"/>
                        <path d="M28.7234 41.6339L35.4724 41.7517C35.6104 41.7541 35.7204 41.868 35.718 42.006L35.4125 59.5034C35.4101 59.6414 35.2963 59.7514 35.1582 59.749L28.4092 59.6312L28.7234 41.6339Z"
                              fill="#8C8F9A"/>
                        <path d="M59.7141 42.4249C59.7166 42.2868 59.8304 42.1769 59.9685 42.1793L66.7174 42.2971L66.4033 60.2944L59.6543 60.1765C59.5163 60.1741 59.4063 60.0603 59.4087 59.9222L59.7141 42.4249Z"
                              fill="#8C8F9A"/>
                        ...
                        <g filter="url(#filter1_d_503:1671)">
                            ...
                            <g clip-path="url(#clip0_503:1671)">
                                <g clip-path="url(#clip1_503:1671)">
                                    <path d="M39.6404 66.166L36.8185 69.4122L36.0071 68.7069L38.1236 66.2721L35.6888 64.1556L36.3942 63.3442L39.6404 66.166ZM28.2852 66.9601L30.72 69.0766L30.0146 69.888L26.7684 67.0661L29.5903 63.82L30.4012 64.5253L28.2852 66.9601ZM32.3556 71.526L31.2143 71.6058L34.0532 61.7062L35.1945 61.6264L32.3556 71.526Z"
                                          fill="#141B38"/>
                                </g>
                            </g>
