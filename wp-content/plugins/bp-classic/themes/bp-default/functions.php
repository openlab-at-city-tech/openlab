...
function bp_dtheme_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'bp-classic' ),
	) );
...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'bp-classic' ),
		'accepted'          => __( 'Accepted', 'bp-classic' ),
		'rejected'          => __( 'Rejected', 'bp-classic' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'bp-classic' ),
		'show_x_comments'   => __( 'Show all %d comments', 'bp-classic' ),
		'show_all'          => __( 'Show all', 'bp-classic' ),
		'comments'          => __( 'comments', 'bp-classic' ),
		'close'             => __( 'Close', 'bp-classic' ),
		'view'              => __( 'View', 'bp-classic' ),
		'mark_as_fav'	    => __( 'Favorite', 'bp-classic' ),
		'remove_fav'	    => __( 'Remove Favorite', 'bp-classic' ),
		'unsaved_changes'   => __( 'Your profile has unsaved changes. If you leave the page, the changes will be lost.', 'bp-classic' ),
	);
...
function bp_dtheme_widgets_init() {
	...
	register_sidebar( array(
		'name'          => 'Sidebar',
		'id'            => 'sidebar-1',
		'description'   => __( 'The sidebar widget area', 'bp-classic' ),
	...
	register_sidebar( array(
		'name' => __( 'First Footer Widget Area', 'bp-classic' ),
		'id' => 'first-footer-widget-area',
		'description' => __( 'The first footer widget area', 'bp-classic' ),
	...
	register_sidebar( array(
		'name' => __( 'Second Footer Widget Area', 'bp-classic' ),
		'id' => 'second-footer-widget-area',
		'description' => __( 'The second footer widget area', 'bp-classic' ),
		'before_widget' => '<li id="%1$s" class="widget %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Third Footer Widget Area', 'bp-classic' ),
		'id' => 'third-footer-widget-area',
		'description' => __( 'The third footer widget area', 'bp-classic' ),
		'before_widget' => '<li id="%1$s" class="widget %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Fourth Footer Widget Area', 'bp-classic' ),
		'id' => 'fourth-footer-widget-area',
		'description' => __( 'The fourth footer widget area', 'bp-classic' ),
		'before_widget' => '<li id="%1$s" class="widget %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
		...
		<div class="comment-content">
			<div class="comment-meta">
				<p>
					<?php
						...
						printf( __( '<a href="%1$s" rel="nofollow">%2$s</a> said on <a href="%3$s"><span class="time-since">%4$s</span></a>', 'bp-classic' ), get_comment_author_url(), get_comment_author(), get_comment_link(), get_comment_date() );
					?>
				</p>
			</div>
			...
			<div class="comment-entry">
				<?php if ( $comment->comment_approved == '0' ) : ?>
				 	<em class="moderate"><?php _e( 'Your comment is awaiting moderation.', 'bp-classic' ); ?></em>
				<?php endif; ?>
			...
			<div class="comment-options">
					...
					<?php if ( current_user_can( 'edit_comment', $comment->comment_ID ) ) : ?>
						<?php printf( '<a class="button comment-edit-link bp-secondary-action" href="%1$s" title="%2$s">%3$s</a> ', get_edit_comment_link( $comment->comment_ID ), esc_attr__( 'Edit comment', 'bp-classic' ), __( 'Edit', 'bp-classic' ) ); ?>
					<?php endif; ?>
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'bp-classic' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ); ?></p>
	</div>
...
function bp_dtheme_comment_form( $default_labels ) {
	...
	$fields    =  array(
		'author' => '<p class="comment-form-author">' . '<label for="author">' . __( 'Name', 'bp-classic' ) . ( $req ? '<span class="required"> *</span>' : '' ) . '</label> ' .
		            '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>',
		'email'  => '<p class="comment-form-email"><label for="email">' . __( 'Email', 'bp-classic' ) . ( $req ? '<span class="required"> *</span>' : '' ) . '</label> ' .
		            '<input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>',
		'url'    => '<p class="comment-form-url"><label for="url">' . __( 'Website', 'bp-classic' ) . '</label>' .
	...
	$new_labels = array(
		...
		'logged_in_as'   => '',
		'must_log_in'    => '<p class="alert">' . sprintf( __( 'You must be <a href="%1$s">logged in</a> to post a comment.', 'bp-classic' ), wp_login_url( get_permalink() ) )	. '</p>',
		'title_reply'    => __( 'Leave a reply', 'bp-classic' )
	);
...
function bp_dtheme_content_nav( $nav_id ) {
	...
	if ( !empty( $wp_query->max_num_pages ) && $wp_query->max_num_pages > 1 ) : ?>
		...
		<div id="<?php echo $nav_id; ?>" class="navigation">
			<div class="alignleft"><?php next_posts_link( __( '&larr; Previous Entries', 'bp-classic' ) ); ?></div>
			<div class="alignright"><?php previous_posts_link( __( 'Next Entries &rarr;', 'bp-classic' ) ); ?></div>
		</div><!-- #<?php echo $nav_id; ?> -->
