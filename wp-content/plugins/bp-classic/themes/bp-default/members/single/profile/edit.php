...
<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
			...
			<div<?php bp_field_css_class( 'editfield' ); ?>>
				...
				<?php if ( 'multiselectbox' == bp_get_the_profile_field_type() ) : ?>
					...
					<?php if ( !bp_get_the_profile_field_is_required() ) : ?>
						...
						<a class="clear-value" href="javascript:clear( '<?php bp_the_profile_field_input_name(); ?>' );"><?php _e( 'Clear', 'bp-classic' ); ?></a>
				...
				<?php if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
					<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
						<?php printf( __( 'This field can be seen by: <span class="current-visibility-level">%s</span>', 'bp-classic' ), bp_get_the_profile_field_visibility_level_label() ) ?> <a href="#" class="visibility-toggle-link"><?php _e( 'Change', 'bp-classic' ); ?></a>
					</p>
					...
					<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
						...
						<a class="field-visibility-settings-close" href="#"><?php _e( 'Close', 'bp-classic' ) ?></a>
					</div>
				<?php else : ?>
	...
	<div class="submit">
		<input type="submit" name="profile-group-edit-submit" id="profile-group-edit-submit" value="<?php esc_attr_e( 'Save Changes', 'bp-classic' ); ?> " />
	</div>
