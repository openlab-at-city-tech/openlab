<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'bp-classic'); ?></label>
	...
	<label for="subject"><?php _e( 'Subject', 'bp-classic'); ?></label>
	<input type="text" name="subject" id="subject" value="<?php bp_messages_subject_value(); ?>" />

	<label for="content"><?php _e( 'Message', 'bp-classic'); ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php esc_attr_e( "Send Message", 'bp-classic' ); ?>" name="send" id="send" />
	</div>
