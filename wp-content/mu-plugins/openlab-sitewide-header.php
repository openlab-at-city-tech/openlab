...
HTML;
    ...
    <form action="{$form_action}" method="post" id="search-form-{$mode}-{$location}" class="form-inline">
		...
		<label for="search-terms-{$mode}-{$location}" class="screen-reader-text">Search by People or Group Type</label>
		...
		<label for="search-which-{$mode}-{$location}" class="screen-reader-text">Select the Item Type to Search</label>
        ...
        <button class="btn btn-primary top-align search-submit" id="search-submit-{$mode}-{$location}" type="submit"><i class="fa fa-search"></i><span class="screen-reader-text">Submit</span></button>
