            ...
            <div class="container-fluid footer-desktop hidden-xs">
                <div class="row row-footer">
                    <div class="col-sm-12 col-logos">
                        ...
                        <p class="semibold"><a class="pull-left" href="http://www.citytech.cuny.edu/" target="_blank"><img src="<?php echo bp_root_domain(); ?>/wp-content/mu-plugins/css/images/ctnyc_seal.png" alt="New York City College of Technology" border="0" /></a>
                ...
                <div class="footer-wrapper">
                    <div class="row row-footer">
                        <div class="col-sm-12 col-logos">
                            ...
                            <p class="clearfix mobile-logos"><a class="pull-left" href="http://www.citytech.cuny.edu/" target="_blank"><img class="img-responsive" src="<?php echo bp_root_domain(); ?>/wp-content/mu-plugins/css/images/ctnyc_seal.png" alt="New York City College of Technology" border="0" /></a>
