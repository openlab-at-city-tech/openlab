...
function openlab_mu_enqueue() {
	...
	if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
		...
		wp_register_script('openlab-nav-js', plugins_url('js', __FILE__) . '/openlab/openlab.nav.js', array('jquery'), '1.6.8.2', true);
		...
		wp_enqueue_script( 'openlab-smoothscroll', content_url( 'js/smoothscroll.js' ), array( 'jquery' ), '1.6.8.2' );
