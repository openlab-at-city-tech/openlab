<?php
	    ...
	    {
		echo "<option value='advertising-design-and-graphic-arts'>Advertising Design and Graphic Arts</option>
		...
		echo "<option value='african-american-studies'>African-American Studies</option>
