...
class lingonberry_flickr_widget extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 
			'classname' 	=> 'lingonberry_flickr_widget', 
			'description' 	=> __( 'Displays your latest Flickr photos.', 'lingonberry' ) 
		);
        parent::__construct( 'lingonberry_flickr_widget', __( 'Flickr Widget', 'lingonberry' ), $widget_ops );
    }
