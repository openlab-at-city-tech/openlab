<?php $display = johannes_get_post_layout_options('a'); ?>

<article <?php post_class('johannes-post johannes-layout-a category-pill'); ?>>
    
    <?php if ( $fimg = johannes_get_featured_image( 'johannes-a' ) ): ?>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-<?php echo esc_attr($display['width'] + 3); ?> col-lg-<?php echo esc_attr($display['width'] + 1); ?> col-xl-<?php echo esc_attr($display['width']); ?>">
