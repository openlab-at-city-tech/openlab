<?php $display = johannes_get_post_layout_options('fa_d'); ?>

<article <?php post_class('johannes-layout-fa-d johannes-overlay overlay-content-left-small category-pill category-pill-small entry-meta-small'); ?>>
    ...
    <?php if ( $fimg = johannes_get_featured_image( 'johannes-fa-d' ) ): ?>
