<?php $display = johannes_get_post_layout_options('d'); ?>

<article <?php post_class('johannes-post johannes-layout-d category-pill category-pill-small entry-meta-small'); ?>>
    ...
    <?php if( $display['rm'] ): ?>
	    <div class="entry-footer">
	        <a href="<?php the_permalink(); ?>" class="johannes-button johannes-button-secondary johannes-button-small"><?php echo __johannes( 'read_more'); ?></a>
	    </div>
    <?php endif; ?>
</article>