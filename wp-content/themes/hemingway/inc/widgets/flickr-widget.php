...
class hemingway_flickr_widget extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 
			'classname'		=> 'hemingway_flickr_widget', 
			'description' 	=> __( 'Displays your latest Flickr photos.', 'hemingway' ) 
		);
        parent::__construct( 'hemingway_flickr_widget', __( 'Flickr Widget', 'hemingway' ), $widget_ops );
    }
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'id' ); ?>" name="<?php echo $this->get_field_name( 'id' ); ?>" type="text" class="widefat" value="<?php echo esc_attr( $fli_id ); ?>" /></label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of images to display:', 'hemingway' ); ?>
			<input id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" class="widefat" value="<?php echo esc_attr( $fli_number ); ?>" /></label>
		</p>
