...
<!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"85px"},"color":{"text":"#181719"}}} -->
<h2 class="wp-block-heading has-text-color" style="color:#181719;font-size:85px;font-style:normal;font-weight:700"><?php esc_html_e('Dana Smith','fse-freelancer-portfolio'); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"8px"},"spacing":{"padding":{"left":"var:preset|spacing|50","right":"var:preset|spacing|50","top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"fontSize":"small"} -->
<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link wp-element-button" style="border-radius:8px;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--50)"><?php esc_html_e('Download CV','fse-freelancer-portfolio'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
