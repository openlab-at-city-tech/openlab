...
$ahstheme_sm = array('Flickr','Facebook','YouTube','LinkedIn','Delicious','Twitter');
...
$options = array (
	...
	array("name" => "Professional Goals Page",
		"id" => $shortname."_goalspage",
		'help'=>'An excerpt of this page is shown in the Professional Goals box on the homepage.',
		"type" => "pages"),
	
	array("name" => "Academic Profile Page",
		"id" => $shortname."_profilepage",
		'help'=>'An excerpt of this page is shown in the Academic Profile box on the homepage.',
		"type" => "pages"),
	
	array("name" => "Critical Writing Category",
		"id" => $shortname."_writingcat",
		'options' => $cats,
		"type" => "select"),
	...
	array("name" => "Contact Settings",
		"id" => $shortname."_contact_settings",
		"type" => "header"),
	
	array("name" => "Intro Text",
		"id" => $shortname."_contactintro",
		'std' => 'I enjoy hearing from everyone. Please write to me and I will get back to you as soon as I can.',
		'help'=>'This text is shown above the Contact form on the homepage.',
		"type" => "textarea",
		'rows'=>2),
	...
	array("name" => "Email",
		...
		'help'=>'Emails submitted in the contact box on the homepage, or the contact form created with the <code>[contact_form]</code> shortcode, are sent here.',
		'size'=>30),
	
	array("name" => "Social Media URLs",
		"id" => $shortname."_socialmedia",
		'help'=>'No http:// in any of the URLs below.',
		"type" => "header")
);

foreach ($ahstheme_sm as $m) {
	$options[] = array(
		'id'=>'ahstheme_social_'.$m,
		'name'=>$m,
		'type'=>'text',
		'icon'=>true,
	);
...
<ol>
	...
	<li><a href="#<?php echo $shortname; ?>_contact_settings">Contact Settings</a></li>
	<li><a href="#<?php echo $shortname; ?>_socialmedia">Social Media URLs</a></li>
