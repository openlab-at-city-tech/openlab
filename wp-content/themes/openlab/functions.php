...
function openlab_load_scripts_high_priority() {
    ...
    if (CSS_DEBUG) {
        wp_register_style('main-styles', $stylesheet_dir_uri . '/style.less', array(), '1.6.9.9', 'all');
        wp_enqueue_style('main-styles');
    } else {

        wp_register_style('main-styles', $stylesheet_dir_uri . '/style.css', array(), '1.6.9.9', 'all');
        wp_enqueue_style('main-styles');
    }
