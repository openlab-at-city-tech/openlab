...
function openlab_load_scripts() {
    ...
    if (!is_admin()) {
        ...
        wp_register_script('utility', $stylesheet_dir_uri . '/js/utility.js', $utility_deps, '1.6.8.6', true);
...
function openlab_load_scripts_high_priority() {
    ...
    if (CSS_DEBUG) {
        wp_register_style('main-styles', $stylesheet_dir_uri . '/style.less', array(), '1.6.8.7', 'all');
        wp_enqueue_style('main-styles');
    } else {

        wp_register_style('main-styles', $stylesheet_dir_uri . '/style.css', array(), '1.6.8.7', 'all');
        wp_enqueue_style('main-styles');
    }
