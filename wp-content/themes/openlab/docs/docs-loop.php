...
<div class="info-panel panel panel-default doctable-panel">
    <table class="doctable table table-striped">
        ...
        <tbody>
            <?php while ( bp_docs_has_docs( [ 'update_attachment_cache' => true ] ) ) : bp_docs_the_doc(); ?>
				<tr<?php bp_docs_doc_row_classes(); ?> data-doc-id="<?php echo get_the_ID() ?>">
                    <td class="title-cell">
                        <span class="title-wrapper">
                            <?php bp_docs_genericon( 'document' ); ?><a class="hyphenate truncate-on-the-fly" href="<?php bp_docs_group_doc_permalink() ?>" data-basevalue="80" data-minvalue="55" data-basewidth="376"><?php the_title() ?></a> <?php bp_docs_doc_trash_notice(); ?>
                            <span class="original-copy hidden"><?php the_title() ?></span>
                        </span>

						<?php if ( bp_docs_get_excerpt_length() ) : ?>
							<div class="doc-excerpt hyphenate">
								<?php the_excerpt() ?>
							</div>
						<?php endif; ?>
