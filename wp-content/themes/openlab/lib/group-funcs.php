	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="collaboration-tool-toggle">
				...
				<p class="collaboration-tool-gloss italics">Add a discussion forum to the <?php echo esc_html( $group_label_uc ); ?> Profile. <a target="_blank" href="https://openlab.citytech.cuny.edu/blog/help/discussion-forums/">Learn more</a> in OpenLab Help.</p>
			</div>
			...
			<div class="collaboration-tool-toggle">
				...
				<p class="collaboration-tool-gloss italics">Add collaborative docs that <?php echo esc_html( $group_label_uc ); ?> members can create and edit together. <a target="_blank" href="https://openlab.citytech.cuny.edu/blog/help/using-docs/">Learn more</a> in OpenLab Help.</p>
			</div>
			...
			<div class="collaboration-tool-toggle">
				...
				<p class="collaboration-tool-gloss italics">Upload and add links to files on the <?php echo esc_html( $group_label_uc ); ?> Profile. <a target="_blank" href="https://openlab.citytech.cuny.edu/blog/help/using-files/">Learn more</a> in OpenLab Help.</p>
			</div>
		</div>
