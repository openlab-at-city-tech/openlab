<?php if ( !post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
		...
		<div class="typology-pagination typology-comments-pagination">
			<?php echo $comment_pagination = get_comment_pages_count() > 1 && get_option( 'page_comments' ) ? paginate_comments_links( array( 'echo' => false, 'prev_text' => '<i class="fa fa-chevron-left"></i>', 'next_text' => '<i class="fa fa-chevron-right"></i>', 'type' => 'list'  ) ) : ''; ?>
		</div>
