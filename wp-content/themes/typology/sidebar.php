			...
			<?php else: ?>
				<div class="widget">
					<div class="textwidget">
						<p><?php echo wp_kses_post( sprintf( __( 'Your sidebar area is currently empty. Hurry up and <a href="%s" target="_blank" rel="noopener">add some widgets</a>.', 'typology' ), admin_url( 'widgets.php' ) ) );?></p>
					</div>
				</div>
			<?php endif; ?>
	<?php endif; ?>
