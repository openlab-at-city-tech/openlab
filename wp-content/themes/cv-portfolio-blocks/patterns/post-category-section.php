...
<p class="has-text-color has-poppins-font-family has-upper-heading-font-size" style="color:#1a1a1e;line-height:2">'. esc_html__('UI Designer From USA, I Have rich Experience in ui design &amp; building and<br>customization lorem ipsum dummy text.','cv-portfolio-blocks') .'</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"2"}},"fontSize":"upper-heading","fontFamily":"poppins"} -->
<p class="has-poppins-font-family has-upper-heading-font-size" style="line-height:2">'. esc_html__('Lorem ipsum dolor sit amet, consectetur sed do eiusmod tencididunt ut before et dolore Lorem ipsum dolor sit amet, consectetur sed do eiusmod tencididunt ut before et dolore magnaa','cv-portfolio-blocks') .'</p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading has-poppins-font-family has-upper-heading-font-size" style="font-style:normal;font-weight:500;line-height:2.5">'. esc_html__('Age - 25 Years','cv-portfolio-blocks') .'<br>'. esc_html__('Email - support@example.com','cv-portfolio-blocks') .'<br>'. esc_html__('Freelancer - Available','cv-portfolio-blocks') .'</h3>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
