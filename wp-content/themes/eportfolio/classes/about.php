...
if( !class_exists('ePortfolio_About_page') ):
	...
	class ePortfolio_About_page{
        ...
        function eportfolio_backend_menu(){
            ...
            add_theme_page(esc_html__( 'ePortfolio Options','eportfolio' ), esc_html__( 'ePortfolio Options','eportfolio' ), 'activate_plugins', 'eportfolio-about', array($this, 'eportfolio_main_page'));
