    ...
    class ePortfolio_Dashboard_Notice
    {
        ...
        {	
        	...
        	if( $this->eportfolio_show_hide_notice() ){
	            ...
	            add_action( 'admin_notices',array( $this,'eportfolio_admin_notiece' ) );
        ...
        // Define Global Value
        public static function eportfolio_admin_notiece(){
           ...
           <div class="updated notice is-dismissible welcome-panel twp-eportfolio-notice">
                ...
                <p>
                    <a class="button button-primary twp-install-active" href="javascript:void(0)"><?php esc_html_e('Install and activate recommended plugins','eportfolio'); ?></a>
                    <span class="quick-loader-wrapper"><span class="quick-loader"></span></span>

                    <a target="_blank" class="button button-primary" href="<?php echo esc_url( 'https://preview.themeinwp.com/eportfolio/' ); ?>"><?php esc_html_e('View Demo','eportfolio'); ?></a>
