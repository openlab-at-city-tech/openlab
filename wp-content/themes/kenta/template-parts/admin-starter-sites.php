...
<div class="kenta-starter-sites-placeholder">
    <p><?php esc_html_e( 'Kenta comes with many starter sites with various designs to choose from. Install the Companion plugin to access our starter sites.', 'kenta' ); ?></p>
    ...
    >
        ...
        <span><?php esc_html_e( 'Get Started', 'kenta' ); ?></span>
    </button>
</div>
