 ...
 */
	...
	if (weaver_getopt('ttw_hide_special_post_sidebars'))
	    echo('<div id="container" class="one-column container-archive">' . "\n");
	else
	    echo('<div id="container" class="container-archive">' . "\n");
...
<?php if ( is_day() ) : ?>
				<?php printf( __( 'Daily Archives: <span>%s</span>', WEAVER_TRANS ), get_the_date() ); ?>
<?php elseif ( is_month() ) : ?>
				<?php printf( __( 'Monthly Archives: <span>%s</span>', WEAVER_TRANS ), get_the_date('F Y') ); ?>
<?php elseif ( is_year() ) : ?>
				<?php printf( __( 'Yearly Archives: <span>%s</span>', WEAVER_TRANS ), get_the_date('Y') ); ?>
<?php else : ?>
				<?php _e( 'Blog Archives', WEAVER_TRANS ); ?>
<?php endif; ?>
