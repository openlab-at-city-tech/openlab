<?php
/**
 * Template Name: Page with Posts (2 cols)
 *
...
<?php
	...
	if (weaver_is_checked_page_opt('ttw_hide_sidebars')) echo("<div id=\"container\" class=\"one-column page-with-posts page-with-postsfull2\">\n");
	else echo("<div id=\"container\" class=\"page-with-posts page-with-postsfull2\">\n");
