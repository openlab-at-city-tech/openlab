...
function ttrust_scripts() {
	...
	wp_enqueue_style( 'hero-style', get_stylesheet_uri(), false );
    ...
    wp_enqueue_script( 'hero-wait-for-images', get_template_directory_uri() . '/js/jquery.waitforimages.min.js', array('jquery'), '1.0', true );
    wp_enqueue_script('hero-isotope', get_bloginfo('template_url').'/js/isotope.pkgd.min.js', array('jquery'), '2.2.0', true);
...
function ttrust_custom_flush_rules(){
...
add_action('after_switch_theme', 'ttrust_custom_flush_rules');
