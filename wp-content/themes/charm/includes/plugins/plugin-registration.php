...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'ThemeRain Portfolio', // The plugin name.
			'slug'               => 'themerain-portfolio', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/includes/plugins/themerain-portfolio.zip', // The plugin source.
