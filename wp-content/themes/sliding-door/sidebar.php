...
<li id="archives" class="widget-container"> <h3 class="widget-title"><?php _e( 'Archives', 'sliding-door' ); ?></h3>

<ul> <?php wp_get_archives( 'type=monthly' ); ?> </ul> </li>

<li id="meta" class="widget-container"> <h3 class="widget-title"><?php _e( 'Meta', 'sliding-door' ); ?></h3> <ul> <?php wp_register(); ?> <li><?php wp_loginout(); ?></li> <?php wp_meta(); ?> </ul> </li>
...
<li class="widget-container"> <h3 class="widget-title"><?php _e( 'Categories', 'sliding-door' ); ?></h3> <ul> <?php
