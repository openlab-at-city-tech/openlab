...
function groups_get_groups( $args = '' ) {
	...
	$defaults = array(
		...
		'include' => false, //include group_ids
	...
	switch ( $type ) {
		case 'active': default:
			$groups = BP_Groups_Group::get_active( $per_page, $page, $user_id, $include, $search_terms, $populate_extras );
			break;
		case 'newest':
			$groups = BP_Groups_Group::get_newest( $per_page, $page, $user_id, $include, $search_terms, $populate_extras );
			break;
		case 'popular':
			$groups = BP_Groups_Group::get_popular( $per_page, $page, $user_id, $include, $search_terms, $populate_extras );
			break;
		case 'alphabetical':
			$groups = BP_Groups_Group::get_alphabetically( $per_page, $page, $user_id, $include, $search_terms, $populate_extras );
			break;
		case 'random':
			$groups = BP_Groups_Group::get_random( $per_page, $page, $user_id, $include, $search_terms, $populate_extras );
			break;
		...
		case 'most-forum-posts':
			...
			break;
		case 'wds-commands':
			$meta_key="wds_group_type";
			$meta_value="Command";
			$groups = BP_Groups_Group::wds_get_by_meta( $per_page, $page, $user_id, $search_terms, $populate_extras, $meta_key, $meta_value );
			break;
		case 'wds-stations':
			$meta_key="wds_group_type";
			$meta_value="Station";
