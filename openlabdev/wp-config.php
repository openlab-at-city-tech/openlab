...
define('DB_NAME', 'openlab_devorg');

/** MySQL database username */
define('DB_USER', 'openlab_2');

/** MySQL database password */
define('DB_PASSWORD', 'gDymUyFY');
...
@ini_set('error_log','/usr/home/openlab/openlabdev/public_html/php_error.log');
